...
enum class posix_open_mode_text_behavior { always_binary = 0, text, wide_text, u8_text, u16_text };
...
template <::std::integral ch_type>
inline constexpr basic_posix_io_observer<ch_type>
io_stream_ref_define(basic_posix_io_observer<ch_type> other) noexcept {
    return other;
}
