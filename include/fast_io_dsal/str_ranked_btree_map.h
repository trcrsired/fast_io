...
#include "impl/str_ranked_btree_map.h"
...
using basic_str_ranked_btree_map = ::fast_io::containers::basic_str_ranked_btree_map<T, M, Alloc>;

template <typename M>
using str_ranked_btree_map = ::fast_io::basic_str_ranked_btree_map<char, M>;
template <typename M>
using wstr_ranked_btree_map = ::fast_io::basic_str_ranked_btree_map<wchar_t, M>;
template <typename M>
using u8str_ranked_btree_map = ::fast_io::basic_str_ranked_btree_map<char8_t, M>;
template <typename M>
using u16str_ranked_btree_map = ::fast_io::basic_str_ranked_btree_map<char16_t, M>;
template <typename M>
...
namespace tlc
{
template <typename T, typename M, typename Alloc = ::fast_io::native_thread_local_allocator>
using basic_str_ranked_btree_map = ::fast_io::containers::basic_str_ranked_btree_map<T, M, Alloc>;

template <typename M>
using str_ranked_btree_map = ::fast_io::tlc::basic_str_ranked_btree_map<char, M>;
template <typename M>
using wstr_ranked_btree_map = ::fast_io::tlc::basic_str_ranked_btree_map<wchar_t, M>;
template <typename M>
using u8str_ranked_btree_map = ::fast_io::tlc::basic_str_ranked_btree_map<char8_t, M>;
template <typename M>
