...
template <bool full, ::std::size_t base, bool uppercase, ::std::integral char_type, my_unsigned_integral T>
constexpr char_type *grouping_mul_sep_impl(basic_lc_all<char_type> const *__restrict all, char_type *iter,
                                           T t) noexcept {
...
print_reserve_size_grouping_timestamp_impl(basic_lc_all<char_type> const *__restrict all) {
