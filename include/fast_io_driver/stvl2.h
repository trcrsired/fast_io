...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define_impl_for_stvl2_header(char_type *iter,
                                                                       stvl2::stvl2_header tg) noexcept {
    if constexpr (::std::same_as<char_type, char>) {
...
template <::std::integral char_type>
inline constexpr char_type *
print_reserve_define_impl_for_stvl2_header_tag_smp(char_type *iter, stvl2::stvl2_header_tag_smp tg) noexcept {
    iter = print_reserve_define_impl_for_stvl2_tag(iter, tg);
    if constexpr (::std::same_as<char_type, char>)
        iter = copy_string_literal("\nflags: ", iter);
    else if constexpr (::std::same_as<char_type, wchar_t>)
...
template <::std::integral char_type>
inline constexpr char_type *
print_reserve_define_impl_for_stvl2_firmware_flags(char_type *iter, stvl2::stvl2_firmware_flags tg) noexcept {
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define_impl_for_stvl2_module(char_type *iter,
                                                                       stvl2::stvl2_module st) noexcept {
    if constexpr (::std::same_as<char_type, char>) {
...
template <::std::integral char_type>
inline constexpr char_type *
print_reserve_define_impl_for_stvl2_struct_tag_smp(char_type *iter, stvl2::stvl2_struct_tag_smp st) noexcept {
    iter = print_reserve_define_impl_for_stvl2_tag(iter, st);
    if constexpr (::std::same_as<char_type, char>) {
        iter = copy_string_literal("\nflags: ", iter);
