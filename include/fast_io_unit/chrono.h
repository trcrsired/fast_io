...
print_reserve_size(io_reserve_type_t<char_type, ::std::chrono::duration<Rep, Period>>) noexcept {
...
print_reserve_size(io_reserve_type_t<char_type, ::std::chrono::year_month_day>) noexcept {
