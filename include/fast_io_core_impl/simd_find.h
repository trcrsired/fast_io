...
inline constexpr char_type const *find_simd_common_all_impl(char_type const *first, char_type const *last,
    ...
    if constexpr (findnot) {
        ...
        return find_simd_common_condition_impl<vec_size>(
            first, last,
            ...
            */
            ...
            if constexpr (ishtml) {
                ...
                return find_simd_common_all_impl<findnot, vec_size>(
                    first, last, [&](simd_vector_type const &simdvec) noexcept {
...
template <char8_t lfch, bool findnot, ::std::integral char_type>
inline constexpr char_type const *find_simd_constant_common_impl(char_type const *first,
                                                                 char_type const *last) noexcept {
