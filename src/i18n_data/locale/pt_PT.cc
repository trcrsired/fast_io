...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("pt_PT"),
         ...
         .title = tsc("Portuguese locale for Portugal"),
         ...
         .tel = tsc(""),
         .fax = tsc(""),
         .language = tsc("European Portuguese"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"pt_PT"),
         ...
         .title = tsc(L"Portuguese locale for Portugal"),
         ...
         .tel = tsc(L""),
         .fax = tsc(L""),
         .language = tsc(L"European Portuguese"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"pt_PT"),
         ...
         .title = tsc(u8"Portuguese locale for Portugal"),
         ...
         .tel = tsc(u8""),
         .fax = tsc(u8""),
         .language = tsc(u8"European Portuguese"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"pt_PT"),
         ...
         .title = tsc(u"Portuguese locale for Portugal"),
         ...
         .tel = tsc(u""),
         .fax = tsc(u""),
         .language = tsc(u"European Portuguese"),
