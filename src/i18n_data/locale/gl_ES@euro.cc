...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("gl_ES@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("Galician locale for Spain with Euro"),
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"gl_ES@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"Galician locale for Spain with Euro"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"gl_ES@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"Galician locale for Spain with Euro"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"gl_ES@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"Galician locale for Spain with Euro"),
