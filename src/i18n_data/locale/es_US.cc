...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("es_US"),
         ...
         .title = tsc("Spanish locale for the USA"),
    ...
    .telephone = {.tel_int_fmt = tsc("+%c %a %l"), .int_select = tsc("11"), .int_prefix = tsc("1")},
    .name = {.name_fmt = tsc("%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc("%a%N%f%N%d%N%b%N%h %s %e %r%N%T, %S %z%N%c%N"),
                .country_name = tsc("Estados Unidos"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"es_US"),
         ...
         .title = tsc(L"Spanish locale for the USA"),
    ...
    .paper = {.width = 216, .height = 279},
    .telephone = {.tel_int_fmt = tsc(L"+%c %a %l"), .int_select = tsc(L"11"), .int_prefix = tsc(L"1")},
    .name = {.name_fmt = tsc(L"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(L"%a%N%f%N%d%N%b%N%h %s %e %r%N%T, %S %z%N%c%N"),
                .country_name = tsc(L"Estados Unidos"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"es_US"),
         ...
         .title = tsc(u8"Spanish locale for the USA"),
    ...
    .messages = {.yesexpr = tsc(u8"^[+1sSyY]"),
                 ...
                 .nostr = tsc(u8"no")},
    .paper = {.width = 216, .height = 279},
    .telephone = {.tel_int_fmt = tsc(u8"+%c %a %l"), .int_select = tsc(u8"11"), .int_prefix = tsc(u8"1")},
    .name = {.name_fmt = tsc(u8"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u8"%a%N%f%N%d%N%b%N%h %s %e %r%N%T, %S %z%N%c%N"),
                .country_name = tsc(u8"Estados Unidos"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"es_US"),
         ...
         .title = tsc(u"Spanish locale for the USA"),
    ...
    .paper = {.width = 216, .height = 279},
    .telephone = {.tel_int_fmt = tsc(u"+%c %a %l"), .int_select = tsc(u"11"), .int_prefix = tsc(u"1")},
    .name = {.name_fmt = tsc(u"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u"%a%N%f%N%d%N%b%N%h %s %e %r%N%T, %S %z%N%c%N"),
                .country_name = tsc(u"Estados Unidos"),
