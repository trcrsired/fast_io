...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("ga_IE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("Irish locale for Ireland with Euro"),
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"ga_IE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"Irish locale for Ireland with Euro"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"ga_IE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"Irish locale for Ireland with Euro"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"ga_IE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"Irish locale for Ireland with Euro"),
