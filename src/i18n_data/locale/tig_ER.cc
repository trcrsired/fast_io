...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("tig_ER"),
         ...
         .title = tsc("Tigre language locale for Eritrea"),
    ...
    .time = {.abday = {tsc("ሰ//ዓ"), tsc("ሰኖ "), tsc("ታላሸ"), tsc("ኣረር"), tsc("ከሚሽ"), tsc("ጅምዓ"), tsc("ሰ//ን")},
             .day = {tsc("ሰንበት ዓባይ"), tsc("ሰኖ"), tsc("ታላሸኖ"), tsc("ኣረርባዓ"), tsc("ከሚሽ"), tsc("ጅምዓት"), tsc("ሰንበት ንኢሽ")},
             ...
             .d_t_fmt = tsc("%A፡ %B %e ዮም %Y %r %Z"),
             .d_fmt = tsc("%d//%m//%Y"),
             .t_fmt = tsc("%l:%M:%S %p"),
             .t_fmt_ampm = tsc("%l:%M:%S %p"),
             .date_fmt = tsc("%A፡ %B %e ዮም %r %Z %Y ዓ//ም"),
             .am_pm = {tsc("ቀደም ሰር ምዕል"), tsc("ሓቆ ሰር ምዕል")},
             .week = {7, 19971130, 1},
             .first_weekday = 2},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"tig_ER"),
         ...
         .title = tsc(L"Tigre language locale for Eritrea"),
    ...
    .time = {.abday = {tsc(L"ሰ//ዓ"), tsc(L"ሰኖ "), tsc(L"ታላሸ"), tsc(L"ኣረር"), tsc(L"ከሚሽ"), tsc(L"ጅምዓ"), tsc(L"ሰ//ን")},
             .day = {tsc(L"ሰንበት ዓባይ"), tsc(L"ሰኖ"), tsc(L"ታላሸኖ"), tsc(L"ኣረርባዓ"), tsc(L"ከሚሽ"), tsc(L"ጅምዓት"),
                     tsc(L"ሰንበት ንኢሽ")},
             ...
             .d_t_fmt = tsc(L"%A፡ %B %e ዮም %Y %r %Z"),
             .d_fmt = tsc(L"%d//%m//%Y"),
             .t_fmt = tsc(L"%l:%M:%S %p"),
             .t_fmt_ampm = tsc(L"%l:%M:%S %p"),
             .date_fmt = tsc(L"%A፡ %B %e ዮም %r %Z %Y ዓ//ም"),
             .am_pm = {tsc(L"ቀደም ሰር ምዕል"), tsc(L"ሓቆ ሰር ምዕል")},
             .week = {7, 19971130, 1},
             .first_weekday = 2},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"tig_ER"),
         ...
         .title = tsc(u8"Tigre language locale for Eritrea"),
    ...
    .time = {.abday = {tsc(u8"ሰ//ዓ"), tsc(u8"ሰኖ "), tsc(u8"ታላሸ"), tsc(u8"ኣረር"), tsc(u8"ከሚሽ"), tsc(u8"ጅምዓ"),
                       tsc(u8"ሰ//ን")},
             .day = {tsc(u8"ሰንበት ዓባይ"), tsc(u8"ሰኖ"), tsc(u8"ታላሸኖ"), tsc(u8"ኣረርባዓ"), tsc(u8"ከሚሽ"), tsc(u8"ጅምዓት"),
                     tsc(u8"ሰንበት ንኢሽ")},
             ...
             .d_t_fmt = tsc(u8"%A፡ %B %e ዮም %Y %r %Z"),
             .d_fmt = tsc(u8"%d//%m//%Y"),
             .t_fmt = tsc(u8"%l:%M:%S %p"),
             .t_fmt_ampm = tsc(u8"%l:%M:%S %p"),
             .date_fmt = tsc(u8"%A፡ %B %e ዮም %r %Z %Y ዓ//ም"),
             .am_pm = {tsc(u8"ቀደም ሰር ምዕል"), tsc(u8"ሓቆ ሰር ምዕል")},
             .week = {7, 19971130, 1},
             .first_weekday = 2},
    ...
    .address = {.postal_fmt = tsc(u8"%z%c%T%s%b%e%r"),
                ...
                .lang_name = tsc(u8"ትግረ"),
                .lang_ab = tsc(u8""),
                .lang_term = tsc(u8"tig"),
                .lang_lib = tsc(u8"tig")},
    .measurement = {.measurement = 1}};
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"tig_ER"),
         ...
         .title = tsc(u"Tigre language locale for Eritrea"),
    ...
    .time = {.abday = {tsc(u"ሰ//ዓ"), tsc(u"ሰኖ "), tsc(u"ታላሸ"), tsc(u"ኣረር"), tsc(u"ከሚሽ"), tsc(u"ጅምዓ"), tsc(u"ሰ//ን")},
             .day = {tsc(u"ሰንበት ዓባይ"), tsc(u"ሰኖ"), tsc(u"ታላሸኖ"), tsc(u"ኣረርባዓ"), tsc(u"ከሚሽ"), tsc(u"ጅምዓት"),
                     tsc(u"ሰንበት ንኢሽ")},
             ...
             .d_t_fmt = tsc(u"%A፡ %B %e ዮም %Y %r %Z"),
             .d_fmt = tsc(u"%d//%m//%Y"),
             .t_fmt = tsc(u"%l:%M:%S %p"),
             .t_fmt_ampm = tsc(u"%l:%M:%S %p"),
             .date_fmt = tsc(u"%A፡ %B %e ዮም %r %Z %Y ዓ//ም"),
             .am_pm = {tsc(u"ቀደም ሰር ምዕል"), tsc(u"ሓቆ ሰር ምዕል")},
             .week = {7, 19971130, 1},
             .first_weekday = 2},
