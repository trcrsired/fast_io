...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("en_ZW"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("English locale for Zimbabwe"),
    ...
    .telephone = {.tel_int_fmt = tsc("+%c %a %l"), .int_select = tsc("00"), .int_prefix = tsc("263")},
    .name = {.name_fmt = tsc("%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc("%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc("Zimbabwe"),
                .country_ab2 = tsc("ZW"),
                .country_ab3 = tsc("ZWE"),
                .country_num = 716,
                .country_car = tsc("ZW"),
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"en_ZW"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"English locale for Zimbabwe"),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(L"+%c %a %l"), .int_select = tsc(L"00"), .int_prefix = tsc(L"263")},
    .name = {.name_fmt = tsc(L"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(L"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(L"Zimbabwe"),
                .country_ab2 = tsc(L"ZW"),
                .country_ab3 = tsc(L"ZWE"),
                .country_num = 716,
                .country_car = tsc(L"ZW"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"en_ZW"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"English locale for Zimbabwe"),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(u8"+%c %a %l"), .int_select = tsc(u8"00"), .int_prefix = tsc(u8"263")},
    .name = {.name_fmt = tsc(u8"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u8"Zimbabwe"),
                .country_ab2 = tsc(u8"ZW"),
                .country_ab3 = tsc(u8"ZWE"),
                .country_num = 716,
                .country_car = tsc(u8"ZW"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"en_ZW"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"English locale for Zimbabwe"),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(u"+%c %a %l"), .int_select = tsc(u"00"), .int_prefix = tsc(u"263")},
    .name = {.name_fmt = tsc(u"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u"Zimbabwe"),
                .country_ab2 = tsc(u"ZW"),
                .country_ab3 = tsc(u"ZWE"),
                .country_num = 716,
                .country_car = tsc(u"ZW"),
