...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("aa_DJ"),
         ...
         .title = tsc("Afar language locale for Djibouti (Cadu//Laaqo Dialects)."),
         ...
         .fax = tsc(""),
         .language = tsc("Afar"),
         .territory = tsc("Djibouti"),
         .revision = tsc("0.20"),
         .date = tsc("2003-07-05")},
    .monetary = {.int_curr_symbol = tsc("DJF "),
                 .currency_symbol = tsc("Fdj"),
    ...
    .time = {.abday = {tsc("Aca"), tsc("Etl"), tsc("Tal"), tsc("Arb"), tsc("Kam"), tsc("Gum"), tsc("Sab")},
             .day = {tsc("Acaada"), tsc("Etleeni"), tsc("Talaata"), tsc("Arbaqa"), tsc("Kamiisi"), tsc("Gumqata"),
                     tsc("Sabti")},
             ...
             .mon = {tsc("Qunxa Garablu"), tsc("Naharsi Kudo"), tsc("Ciggilta Kudo"), tsc("Agda Baxis"),
                     tsc("Caxah Alsa"), tsc("Qasa Dirri"), tsc("Qado Dirri"), tsc("Leqeeni"), tsc("Waysu"),
    ...
    .name = {.name_fmt = tsc("%d%t%g%t%m%t%f"),
             .name_gen = tsc(""),
             .name_miss = tsc("Maqanxa"),
             .name_mr = tsc("Toobokoyta"),
             .name_mrs = tsc("Gisti"),
             .name_ms = tsc("")},
    .address = {.postal_fmt = tsc("%z%c%T%s%b%e%r"),
                .country_name = tsc("Yabuuti"),
                .country_post = tsc("DJI"),
                .country_ab2 = tsc("DJ"),
                .country_ab3 = tsc("DJI"),
                .country_num = 262,
                .country_car = tsc("DJI"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"aa_DJ"),
         ...
         .title = tsc(L"Afar language locale for Djibouti (Cadu//Laaqo Dialects)."),
         ...
         .fax = tsc(L""),
         .language = tsc(L"Afar"),
         .territory = tsc(L"Djibouti"),
         .revision = tsc(L"0.20"),
         .date = tsc(L"2003-07-05")},
    .monetary = {.int_curr_symbol = tsc(L"DJF "),
                 .currency_symbol = tsc(L"Fdj"),
    ...
    .time = {.abday = {tsc(L"Aca"), tsc(L"Etl"), tsc(L"Tal"), tsc(L"Arb"), tsc(L"Kam"), tsc(L"Gum"), tsc(L"Sab")},
             .day = {tsc(L"Acaada"), tsc(L"Etleeni"), tsc(L"Talaata"), tsc(L"Arbaqa"), tsc(L"Kamiisi"), tsc(L"Gumqata"),
                     tsc(L"Sabti")},
             ...
             .mon = {tsc(L"Qunxa Garablu"), tsc(L"Naharsi Kudo"), tsc(L"Ciggilta Kudo"), tsc(L"Agda Baxis"),
                     tsc(L"Caxah Alsa"), tsc(L"Qasa Dirri"), tsc(L"Qado Dirri"), tsc(L"Leqeeni"), tsc(L"Waysu"),
    ...
    .telephone = {.tel_int_fmt = tsc(L"+%c %a %l"),
                  ...
                  .int_select = tsc(L"00"),
                  .int_prefix = tsc(L"253")},
    .name = {.name_fmt = tsc(L"%d%t%g%t%m%t%f"),
             .name_gen = tsc(L""),
             .name_miss = tsc(L"Maqanxa"),
             .name_mr = tsc(L"Toobokoyta"),
             .name_mrs = tsc(L"Gisti"),
             .name_ms = tsc(L"")},
    .address = {.postal_fmt = tsc(L"%z%c%T%s%b%e%r"),
                .country_name = tsc(L"Yabuuti"),
                .country_post = tsc(L"DJI"),
                .country_ab2 = tsc(L"DJ"),
                .country_ab3 = tsc(L"DJI"),
                .country_num = 262,
                .country_car = tsc(L"DJI"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"aa_DJ"),
         ...
         .title = tsc(u8"Afar language locale for Djibouti (Cadu//Laaqo Dialects)."),
         ...
         .territory = tsc(u8"Djibouti"),
         .revision = tsc(u8"0.20"),
         .date = tsc(u8"2003-07-05")},
    .monetary = {.int_curr_symbol = tsc(u8"DJF "),
                 .currency_symbol = tsc(u8"Fdj"),
    ...
    .time = {.abday = {tsc(u8"Aca"), tsc(u8"Etl"), tsc(u8"Tal"), tsc(u8"Arb"), tsc(u8"Kam"), tsc(u8"Gum"),
                       tsc(u8"Sab")},
             .day = {tsc(u8"Acaada"), tsc(u8"Etleeni"), tsc(u8"Talaata"), tsc(u8"Arbaqa"), tsc(u8"Kamiisi"),
                     tsc(u8"Gumqata"), tsc(u8"Sabti")},
             ...
             .mon = {tsc(u8"Qunxa Garablu"), tsc(u8"Naharsi Kudo"), tsc(u8"Ciggilta Kudo"), tsc(u8"Agda Baxis"),
                     tsc(u8"Caxah Alsa"), tsc(u8"Qasa Dirri"), tsc(u8"Qado Dirri"), tsc(u8"Leqeeni"), tsc(u8"Waysu"),
    ...
    .telephone = {.tel_int_fmt = tsc(u8"+%c %a %l"),
                  ...
                  .int_prefix = tsc(u8"253")},
    .name = {.name_fmt = tsc(u8"%d%t%g%t%m%t%f"),
             .name_gen = tsc(u8""),
             .name_miss = tsc(u8"Maqanxa"),
             .name_mr = tsc(u8"Toobokoyta"),
             .name_mrs = tsc(u8"Gisti"),
             .name_ms = tsc(u8"")},
    .address = {.postal_fmt = tsc(u8"%z%c%T%s%b%e%r"),
                .country_name = tsc(u8"Yabuuti"),
                .country_post = tsc(u8"DJI"),
                .country_ab2 = tsc(u8"DJ"),
                .country_ab3 = tsc(u8"DJI"),
                .country_num = 262,
                .country_car = tsc(u8"DJI"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"aa_DJ"),
         ...
         .title = tsc(u"Afar language locale for Djibouti (Cadu//Laaqo Dialects)."),
         ...
         .fax = tsc(u""),
         .language = tsc(u"Afar"),
         .territory = tsc(u"Djibouti"),
         .revision = tsc(u"0.20"),
         .date = tsc(u"2003-07-05")},
    .monetary = {.int_curr_symbol = tsc(u"DJF "),
                 .currency_symbol = tsc(u"Fdj"),
    ...
    .time = {.abday = {tsc(u"Aca"), tsc(u"Etl"), tsc(u"Tal"), tsc(u"Arb"), tsc(u"Kam"), tsc(u"Gum"), tsc(u"Sab")},
             .day = {tsc(u"Acaada"), tsc(u"Etleeni"), tsc(u"Talaata"), tsc(u"Arbaqa"), tsc(u"Kamiisi"), tsc(u"Gumqata"),
                     tsc(u"Sabti")},
             ...
             .mon = {tsc(u"Qunxa Garablu"), tsc(u"Naharsi Kudo"), tsc(u"Ciggilta Kudo"), tsc(u"Agda Baxis"),
                     tsc(u"Caxah Alsa"), tsc(u"Qasa Dirri"), tsc(u"Qado Dirri"), tsc(u"Leqeeni"), tsc(u"Waysu"),
    ...
    .telephone = {.tel_int_fmt = tsc(u"+%c %a %l"),
                  ...
                  .int_select = tsc(u"00"),
                  .int_prefix = tsc(u"253")},
    .name = {.name_fmt = tsc(u"%d%t%g%t%m%t%f"),
             .name_gen = tsc(u""),
             .name_miss = tsc(u"Maqanxa"),
             .name_mr = tsc(u"Toobokoyta"),
             .name_mrs = tsc(u"Gisti"),
             .name_ms = tsc(u"")},
    .address = {.postal_fmt = tsc(u"%z%c%T%s%b%e%r"),
                .country_name = tsc(u"Yabuuti"),
                .country_post = tsc(u"DJI"),
                .country_ab2 = tsc(u"DJ"),
                .country_ab3 = tsc(u"DJI"),
                .country_num = 262,
                .country_car = tsc(u"DJI"),
