...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("bhb_IN"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("Bhili(devanagari) language locale for India"),
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"bhb_IN"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"Bhili(devanagari) language locale for India"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"bhb_IN"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"Bhili(devanagari) language locale for India"),
    ...
    .address = {.postal_fmt = tsc(u8"%z%c%T%s%b%e%r"),
                ...
                .lang_name = tsc(u8"भीली"),
                .lang_ab = tsc(u8""),
                .lang_term = tsc(u8"bhb"),
                .lang_lib = tsc(u8"bhb")},
    .measurement = {.measurement = 1}};

inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"bhb_IN"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"Bhili(devanagari) language locale for India"),
