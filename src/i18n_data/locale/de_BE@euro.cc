...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("de_BE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("German locale for Belgium with Euro"),
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"de_BE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"German locale for Belgium with Euro"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"de_BE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"German locale for Belgium with Euro"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"de_BE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"German locale for Belgium with Euro"),
