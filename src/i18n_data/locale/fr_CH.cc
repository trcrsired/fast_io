...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("fr_CH"),
         ...
         .title = tsc("French locale for Switzerland"),
    ...
    .time = {.abday = {tsc("dim"), tsc("lun"), tsc("mar"), tsc("mer"), tsc("jeu"), tsc("ven"), tsc("sam")},
             ...
             .week = {7, 19971130, 4},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc("^[+1OojJsSyY]"), .noexpr = tsc("^[-0nN]"), .yesstr = tsc("oui"), .nostr = tsc("non")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"fr_CH"),
         ...
         .title = tsc(L"French locale for Switzerland"),
    ...
    .time = {.abday = {tsc(L"dim"), tsc(L"lun"), tsc(L"mar"), tsc(L"mer"), tsc(L"jeu"), tsc(L"ven"), tsc(L"sam")},
             ...
             .week = {7, 19971130, 4},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc(L"^[+1OojJsSyY]"),
                 .noexpr = tsc(L"^[-0nN]"),
                 .yesstr = tsc(L"oui"),
                 .nostr = tsc(L"non")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"fr_CH"),
         ...
         .title = tsc(u8"French locale for Switzerland"),
    ...
    .time = {.abday = {tsc(u8"dim"), tsc(u8"lun"), tsc(u8"mar"), tsc(u8"mer"), tsc(u8"jeu"), tsc(u8"ven"),
             ...
             .week = {7, 19971130, 4},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc(u8"^[+1OojJsSyY]"),
                 .noexpr = tsc(u8"^[-0nN]"),
                 .yesstr = tsc(u8"oui"),
                 .nostr = tsc(u8"non")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"fr_CH"),
         ...
         .title = tsc(u"French locale for Switzerland"),
    ...
    .time = {.abday = {tsc(u"dim"), tsc(u"lun"), tsc(u"mar"), tsc(u"mer"), tsc(u"jeu"), tsc(u"ven"), tsc(u"sam")},
             ...
             .week = {7, 19971130, 4},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc(u"^[+1OojJsSyY]"),
                 .noexpr = tsc(u"^[-0nN]"),
                 .yesstr = tsc(u"oui"),
                 .nostr = tsc(u"non")},
    .paper = {.width = 210, .height = 297},
