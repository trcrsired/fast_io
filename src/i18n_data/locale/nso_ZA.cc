...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("nso_ZA"),
         ...
         .title = tsc("Northern Sotho locale for South Africa"),
    ...
    .time = {.abday = {tsc("Son"), tsc("Moš"), tsc("Bed"), tsc("Rar"), tsc("Ne"), tsc("Hla"), tsc("Mok")},
             .day = {tsc("LaMorena"), tsc("Mošupologo"), tsc("Labobedi"), tsc("Laboraro"), tsc("Labone"),
                     tsc("Labohlano"), tsc("Mokibelo")},
             .abmon = {tsc("Jan"), tsc("Feb"), tsc("Mat"), tsc("Apr"), tsc("Mei"), tsc("Jun"), tsc("Jul"), tsc("Ago"),
                       tsc("Set"), tsc("Okt"), tsc("Nof"), tsc("Dis")},
             .mon = {tsc("Janaware"), tsc("Febereware"), tsc("Matšhe"), tsc("Aprele"), tsc("Mei"), tsc("June"),
                     tsc("Julae"), tsc("Agostose"), tsc("Setemere"), tsc("Oktobere"), tsc("Nofemere"), tsc("Disemere")},
             ...
             .am_pm = {tsc(""), tsc("")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc("^[+1yYeE]"), .noexpr = tsc("^[-0nNaA]")},
    ...
    .address = {.postal_fmt = tsc("%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc("Afrika Borwa"),
                .country_post = tsc("ZA"),
                .country_ab2 = tsc("ZA"),
                .country_ab3 = tsc("ZAF"),
                .country_num = 710,
                .country_car = tsc("ZA"),
                .lang_name = tsc("Sesotho sa Leboa"),
                .lang_ab = tsc(""),
                .lang_term = tsc("nso"),
                .lang_lib = tsc("nso")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"nso_ZA"),
         ...
         .title = tsc(L"Northern Sotho locale for South Africa"),
    ...
    .time = {.abday = {tsc(L"Son"), tsc(L"Moš"), tsc(L"Bed"), tsc(L"Rar"), tsc(L"Ne"), tsc(L"Hla"), tsc(L"Mok")},
             .day = {tsc(L"LaMorena"), tsc(L"Mošupologo"), tsc(L"Labobedi"), tsc(L"Laboraro"), tsc(L"Labone"),
                     tsc(L"Labohlano"), tsc(L"Mokibelo")},
             .abmon = {tsc(L"Jan"), tsc(L"Feb"), tsc(L"Mat"), tsc(L"Apr"), tsc(L"Mei"), tsc(L"Jun"), tsc(L"Jul"),
                       tsc(L"Ago"), tsc(L"Set"), tsc(L"Okt"), tsc(L"Nof"), tsc(L"Dis")},
             .mon = {tsc(L"Janaware"), tsc(L"Febereware"), tsc(L"Matšhe"), tsc(L"Aprele"), tsc(L"Mei"), tsc(L"June"),
                     tsc(L"Julae"), tsc(L"Agostose"), tsc(L"Setemere"), tsc(L"Oktobere"), tsc(L"Nofemere"),
                     tsc(L"Disemere")},
             ...
             .am_pm = {tsc(L""), tsc(L"")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc(L"^[+1yYeE]"), .noexpr = tsc(L"^[-0nNaA]")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"nso_ZA"),
         ...
         .title = tsc(u8"Northern Sotho locale for South Africa"),
         ...
         .tel = tsc(u8""),
         .fax = tsc(u8""),
         .language = tsc(u8"Northern Sotho"),
    ...
    .time = {.abday = {tsc(u8"Son"), tsc(u8"Moš"), tsc(u8"Bed"), tsc(u8"Rar"), tsc(u8"Ne"), tsc(u8"Hla"), tsc(u8"Mok")},
             .day = {tsc(u8"LaMorena"), tsc(u8"Mošupologo"), tsc(u8"Labobedi"), tsc(u8"Laboraro"), tsc(u8"Labone"),
                     tsc(u8"Labohlano"), tsc(u8"Mokibelo")},
             .abmon = {tsc(u8"Jan"), tsc(u8"Feb"), tsc(u8"Mat"), tsc(u8"Apr"), tsc(u8"Mei"), tsc(u8"Jun"), tsc(u8"Jul"),
                       tsc(u8"Ago"), tsc(u8"Set"), tsc(u8"Okt"), tsc(u8"Nof"), tsc(u8"Dis")},
             .mon = {tsc(u8"Janaware"), tsc(u8"Febereware"), tsc(u8"Matšhe"), tsc(u8"Aprele"), tsc(u8"Mei"),
                     tsc(u8"June"), tsc(u8"Julae"), tsc(u8"Agostose"), tsc(u8"Setemere"), tsc(u8"Oktobere"),
                     tsc(u8"Nofemere"), tsc(u8"Disemere")},
             ...
             .am_pm = {tsc(u8""), tsc(u8"")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc(u8"^[+1yYeE]"), .noexpr = tsc(u8"^[-0nNaA]")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"nso_ZA"),
         ...
         .title = tsc(u"Northern Sotho locale for South Africa"),
    ...
    .time = {.abday = {tsc(u"Son"), tsc(u"Moš"), tsc(u"Bed"), tsc(u"Rar"), tsc(u"Ne"), tsc(u"Hla"), tsc(u"Mok")},
             .day = {tsc(u"LaMorena"), tsc(u"Mošupologo"), tsc(u"Labobedi"), tsc(u"Laboraro"), tsc(u"Labone"),
                     tsc(u"Labohlano"), tsc(u"Mokibelo")},
             .abmon = {tsc(u"Jan"), tsc(u"Feb"), tsc(u"Mat"), tsc(u"Apr"), tsc(u"Mei"), tsc(u"Jun"), tsc(u"Jul"),
                       tsc(u"Ago"), tsc(u"Set"), tsc(u"Okt"), tsc(u"Nof"), tsc(u"Dis")},
             .mon = {tsc(u"Janaware"), tsc(u"Febereware"), tsc(u"Matšhe"), tsc(u"Aprele"), tsc(u"Mei"), tsc(u"June"),
                     tsc(u"Julae"), tsc(u"Agostose"), tsc(u"Setemere"), tsc(u"Oktobere"), tsc(u"Nofemere"),
                     tsc(u"Disemere")},
             ...
             .am_pm = {tsc(u""), tsc(u"")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc(u"^[+1yYeE]"), .noexpr = tsc(u"^[-0nNaA]")},
    .paper = {.width = 210, .height = 297},
