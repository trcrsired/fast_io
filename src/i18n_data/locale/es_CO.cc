...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("es_CO"),
         ...
         .title = tsc("Spanish locale for Colombia"),
         ...
         .territory = tsc("Colombia"),
         .revision = tsc("1.0"),
         .date = tsc("2000-06-29")},
    .monetary = {.int_curr_symbol = tsc("COP "),
                 .currency_symbol = tsc("$"),
    ...
    .telephone = {.tel_int_fmt = tsc("+%c %a %l"), .int_select = tsc("009"), .int_prefix = tsc("57")},
    .name = {.name_fmt = tsc("%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc("%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc("Colombia"),
                .country_ab2 = tsc("CO"),
                .country_ab3 = tsc("COL"),
                .country_num = 170,
                .country_car = tsc("CO"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"es_CO"),
         ...
         .title = tsc(L"Spanish locale for Colombia"),
         ...
         .territory = tsc(L"Colombia"),
         .revision = tsc(L"1.0"),
         .date = tsc(L"2000-06-29")},
    .monetary = {.int_curr_symbol = tsc(L"COP "),
    ...
    .paper = {.width = 216, .height = 279},
    .telephone = {.tel_int_fmt = tsc(L"+%c %a %l"), .int_select = tsc(L"009"), .int_prefix = tsc(L"57")},
    .name = {.name_fmt = tsc(L"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(L"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(L"Colombia"),
                .country_ab2 = tsc(L"CO"),
                .country_ab3 = tsc(L"COL"),
                .country_num = 170,
                .country_car = tsc(L"CO"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"es_CO"),
         ...
         .title = tsc(u8"Spanish locale for Colombia"),
         ...
         .territory = tsc(u8"Colombia"),
         .revision = tsc(u8"1.0"),
         .date = tsc(u8"2000-06-29")},
    .monetary = {.int_curr_symbol = tsc(u8"COP "),
    ...
    .messages = {.yesexpr = tsc(u8"^[+1sSyY]"),
                 ...
                 .nostr = tsc(u8"no")},
    .paper = {.width = 216, .height = 279},
    .telephone = {.tel_int_fmt = tsc(u8"+%c %a %l"), .int_select = tsc(u8"009"), .int_prefix = tsc(u8"57")},
    .name = {.name_fmt = tsc(u8"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u8"Colombia"),
                .country_ab2 = tsc(u8"CO"),
                .country_ab3 = tsc(u8"COL"),
                .country_num = 170,
                .country_car = tsc(u8"CO"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"es_CO"),
         ...
         .title = tsc(u"Spanish locale for Colombia"),
         ...
         .territory = tsc(u"Colombia"),
         .revision = tsc(u"1.0"),
         .date = tsc(u"2000-06-29")},
    .monetary = {.int_curr_symbol = tsc(u"COP "),
    ...
    .paper = {.width = 216, .height = 279},
    .telephone = {.tel_int_fmt = tsc(u"+%c %a %l"), .int_select = tsc(u"009"), .int_prefix = tsc(u"57")},
    .name = {.name_fmt = tsc(u"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u"Colombia"),
                .country_ab2 = tsc(u"CO"),
                .country_ab3 = tsc(u"COL"),
                .country_num = 170,
                .country_car = tsc(u"CO"),
