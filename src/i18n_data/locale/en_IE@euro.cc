...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("en_IE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("English locale for Ireland with Euro"),
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"en_IE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"English locale for Ireland with Euro"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"en_IE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"English locale for Ireland with Euro"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"en_IE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"English locale for Ireland with Euro"),
