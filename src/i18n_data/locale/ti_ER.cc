...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("ti_ER"),
         ...
         .title = tsc("Tigrigna language locale for Eritrea."),
    ...
    .time = {.abday = {tsc("ሰንበ"), tsc("ሰኑይ"), tsc("ሰሉስ"), tsc("ረቡዕ"), tsc("ሓሙስ"), tsc("ዓርቢ"), tsc("ቀዳም")},
             ...
             .abmon = {tsc("ጥሪ "), tsc("ለካቲ"), tsc("መጋቢ"), tsc("ሚያዝ"), tsc("ግንቦ"), tsc("ሰነ "), tsc("ሓምለ"), tsc("ነሓሰ"),
                       tsc("መስከ"), tsc("ጥቅም"), tsc("ሕዳር"), tsc("ታሕሳ")},
             .mon = {tsc("ጥሪ"), tsc("ለካቲት"), tsc("መጋቢት"), tsc("ሚያዝያ"), tsc("ግንቦት"), tsc("ሰነ"), tsc("ሓምለ"), tsc("ነሓሰ"),
                     tsc("መስከረም"), tsc("ጥቅምቲ"), tsc("ሕዳር"), tsc("ታሕሳስ")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"ti_ER"),
         ...
         .title = tsc(L"Tigrigna language locale for Eritrea."),
    ...
    .time = {.abday = {tsc(L"ሰንበ"), tsc(L"ሰኑይ"), tsc(L"ሰሉስ"), tsc(L"ረቡዕ"), tsc(L"ሓሙስ"), tsc(L"ዓርቢ"), tsc(L"ቀዳም")},
             ...
             .abmon = {tsc(L"ጥሪ "), tsc(L"ለካቲ"), tsc(L"መጋቢ"), tsc(L"ሚያዝ"), tsc(L"ግንቦ"), tsc(L"ሰነ "), tsc(L"ሓምለ"),
                       tsc(L"ነሓሰ"), tsc(L"መስከ"), tsc(L"ጥቅም"), tsc(L"ሕዳር"), tsc(L"ታሕሳ")},
             .mon = {tsc(L"ጥሪ"), tsc(L"ለካቲት"), tsc(L"መጋቢት"), tsc(L"ሚያዝያ"), tsc(L"ግንቦት"), tsc(L"ሰነ"), tsc(L"ሓምለ"),
                     tsc(L"ነሓሰ"), tsc(L"መስከረም"), tsc(L"ጥቅምቲ"), tsc(L"ሕዳር"), tsc(L"ታሕሳስ")},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"ti_ER"),
         ...
         .title = tsc(u8"Tigrigna language locale for Eritrea."),
    ...
    .time = {.abday = {tsc(u8"ሰንበ"), tsc(u8"ሰኑይ"), tsc(u8"ሰሉስ"), tsc(u8"ረቡዕ"), tsc(u8"ሓሙስ"), tsc(u8"ዓርቢ"),
             ...
             .abmon = {tsc(u8"ጥሪ "), tsc(u8"ለካቲ"), tsc(u8"መጋቢ"), tsc(u8"ሚያዝ"), tsc(u8"ግንቦ"), tsc(u8"ሰነ "), tsc(u8"ሓምለ"),
                       tsc(u8"ነሓሰ"), tsc(u8"መስከ"), tsc(u8"ጥቅም"), tsc(u8"ሕዳር"), tsc(u8"ታሕሳ")},
             .mon = {tsc(u8"ጥሪ"), tsc(u8"ለካቲት"), tsc(u8"መጋቢት"), tsc(u8"ሚያዝያ"), tsc(u8"ግንቦት"), tsc(u8"ሰነ"), tsc(u8"ሓምለ"),
                     tsc(u8"ነሓሰ"), tsc(u8"መስከረም"), tsc(u8"ጥቅምቲ"), tsc(u8"ሕዳር"), tsc(u8"ታሕሳስ")},
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"ti_ER"),
         ...
         .title = tsc(u"Tigrigna language locale for Eritrea."),
    ...
    .time = {.abday = {tsc(u"ሰንበ"), tsc(u"ሰኑይ"), tsc(u"ሰሉስ"), tsc(u"ረቡዕ"), tsc(u"ሓሙስ"), tsc(u"ዓርቢ"), tsc(u"ቀዳም")},
             ...
             .abmon = {tsc(u"ጥሪ "), tsc(u"ለካቲ"), tsc(u"መጋቢ"), tsc(u"ሚያዝ"), tsc(u"ግንቦ"), tsc(u"ሰነ "), tsc(u"ሓምለ"),
                       tsc(u"ነሓሰ"), tsc(u"መስከ"), tsc(u"ጥቅም"), tsc(u"ሕዳር"), tsc(u"ታሕሳ")},
             .mon = {tsc(u"ጥሪ"), tsc(u"ለካቲት"), tsc(u"መጋቢት"), tsc(u"ሚያዝያ"), tsc(u"ግንቦት"), tsc(u"ሰነ"), tsc(u"ሓምለ"),
                     tsc(u"ነሓሰ"), tsc(u"መስከረም"), tsc(u"ጥቅምቲ"), tsc(u"ሕዳር"), tsc(u"ታሕሳስ")},
