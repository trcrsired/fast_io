...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("sq_AL"),
         ...
         .title = tsc("Albanian language locale for Albania"),
         ...
         .territory = tsc("Albania"),
         .revision = tsc("1.1"),
         .date = tsc("2004-07-01")},
    .monetary = {.int_curr_symbol = tsc("ALL "),
    ...
    .telephone = {.tel_int_fmt = tsc("+%c ;%a ;%l"), .int_select = tsc("00"), .int_prefix = tsc("355")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"sq_AL"),
         ...
         .title = tsc(L"Albanian language locale for Albania"),
         ...
         .territory = tsc(L"Albania"),
         .revision = tsc(L"1.1"),
         .date = tsc(L"2004-07-01")},
    .monetary = {.int_curr_symbol = tsc(L"ALL "),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(L"+%c ;%a ;%l"), .int_select = tsc(L"00"), .int_prefix = tsc(L"355")},
    ...
    .address = {.postal_fmt = tsc(L"%z%c%T%s%b%e%r"),
                .country_name = tsc(L"Shqipëri"),
                .country_ab2 = tsc(L"AL"),
                .country_ab3 = tsc(L"ALB"),
                .country_num = 8,
                .country_car = tsc(L"AL"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"sq_AL"),
         ...
         .title = tsc(u8"Albanian language locale for Albania"),
         ...
         .territory = tsc(u8"Albania"),
         .revision = tsc(u8"1.1"),
         .date = tsc(u8"2004-07-01")},
    .monetary = {.int_curr_symbol = tsc(u8"ALL "),
    ...
    .messages = {.yesexpr = tsc(u8"^[+1yYpP]"),
                 ...
                 .nostr = tsc(u8"jo")},
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(u8"+%c ;%a ;%l"), .int_select = tsc(u8"00"), .int_prefix = tsc(u8"355")},
    ...
    .address = {.postal_fmt = tsc(u8"%z%c%T%s%b%e%r"),
                .country_name = tsc(u8"Shqipëri"),
                .country_ab2 = tsc(u8"AL"),
                .country_ab3 = tsc(u8"ALB"),
                .country_num = 8,
                .country_car = tsc(u8"AL"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"sq_AL"),
         ...
         .title = tsc(u"Albanian language locale for Albania"),
         ...
         .territory = tsc(u"Albania"),
         .revision = tsc(u"1.1"),
         .date = tsc(u"2004-07-01")},
    .monetary = {.int_curr_symbol = tsc(u"ALL "),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(u"+%c ;%a ;%l"), .int_select = tsc(u"00"), .int_prefix = tsc(u"355")},
    ...
    .address = {.postal_fmt = tsc(u"%z%c%T%s%b%e%r"),
                .country_name = tsc(u"Shqipëri"),
                .country_ab2 = tsc(u"AL"),
                .country_ab3 = tsc(u"ALB"),
                .country_num = 8,
                .country_car = tsc(u"AL"),
