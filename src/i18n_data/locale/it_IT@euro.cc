...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("it_IT@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("Italian locale for Italy with Euro"),
    ...
    .time = {.abday = {tsc("dom"), tsc("lun"), tsc("mar"), tsc("mer"), tsc("gio"), tsc("ven"), tsc("sab")},
             ...
             .week = {7, 19971130, 4},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc("^[+1sSyY]"), .noexpr = tsc("^[-0nN]"), .yesstr = tsc("sì"), .nostr = tsc("no")},
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"it_IT@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"Italian locale for Italy with Euro"),
    ...
    .time = {.abday = {tsc(L"dom"), tsc(L"lun"), tsc(L"mar"), tsc(L"mer"), tsc(L"gio"), tsc(L"ven"), tsc(L"sab")},
             ...
             .week = {7, 19971130, 4},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc(L"^[+1sSyY]"), .noexpr = tsc(L"^[-0nN]"), .yesstr = tsc(L"sì"), .nostr = tsc(L"no")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"it_IT@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"Italian locale for Italy with Euro"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"it_IT@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"Italian locale for Italy with Euro"),
    ...
    .time = {.abday = {tsc(u"dom"), tsc(u"lun"), tsc(u"mar"), tsc(u"mer"), tsc(u"gio"), tsc(u"ven"), tsc(u"sab")},
             ...
             .week = {7, 19971130, 4},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc(u"^[+1sSyY]"), .noexpr = tsc(u"^[-0nN]"), .yesstr = tsc(u"sì"), .nostr = tsc(u"no")},
    .paper = {.width = 210, .height = 297},
