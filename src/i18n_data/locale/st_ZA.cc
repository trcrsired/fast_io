...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("st_ZA"),
         ...
         .title = tsc("Sotho locale for South Africa"),
    ...
    .time = {.abday = {tsc("Son"), tsc("Mma"), tsc("Bed"), tsc("Rar"), tsc("Ne"), tsc("Hla"), tsc("Moq")},
             .day = {tsc("Sontaha"), tsc("Mantaha"), tsc("Labobedi"), tsc("Laboraro"), tsc("Labone"), tsc("Labohlano"),
                     tsc("Moqebelo")},
             .abmon = {tsc("Phe"), tsc("Hla"), tsc("TlH"), tsc("Mme"), tsc("Mot"), tsc("Jan"), tsc("Upu"), tsc("Pha"),
                       tsc("Leo"), tsc("Mph"), tsc("Pud"), tsc("Tsh")},
             .mon = {tsc("Pherekgong"), tsc("Hlakola"), tsc("Tlhakubele"), tsc("Mmese"), tsc("Motsheanong"),
                     tsc("Phupjane"), tsc("Phupu"), tsc("Phato"), tsc("Leotse"), tsc("Mphalane"), tsc("Pudungwana"),
                     tsc("Tshitwe")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"st_ZA"),
         ...
         .title = tsc(L"Sotho locale for South Africa"),
    ...
    .time = {.abday = {tsc(L"Son"), tsc(L"Mma"), tsc(L"Bed"), tsc(L"Rar"), tsc(L"Ne"), tsc(L"Hla"), tsc(L"Moq")},
             .day = {tsc(L"Sontaha"), tsc(L"Mantaha"), tsc(L"Labobedi"), tsc(L"Laboraro"), tsc(L"Labone"),
                     tsc(L"Labohlano"), tsc(L"Moqebelo")},
             .abmon = {tsc(L"Phe"), tsc(L"Hla"), tsc(L"TlH"), tsc(L"Mme"), tsc(L"Mot"), tsc(L"Jan"), tsc(L"Upu"),
                       tsc(L"Pha"), tsc(L"Leo"), tsc(L"Mph"), tsc(L"Pud"), tsc(L"Tsh")},
             .mon = {tsc(L"Pherekgong"), tsc(L"Hlakola"), tsc(L"Tlhakubele"), tsc(L"Mmese"), tsc(L"Motsheanong"),
                     tsc(L"Phupjane"), tsc(L"Phupu"), tsc(L"Phato"), tsc(L"Leotse"), tsc(L"Mphalane"),
                     tsc(L"Pudungwana"), tsc(L"Tshitwe")},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"st_ZA"),
         ...
         .title = tsc(u8"Sotho locale for South Africa"),
         ...
         .tel = tsc(u8""),
         .fax = tsc(u8""),
         .language = tsc(u8"Southern Sotho"),
    ...
    .time = {.abday = {tsc(u8"Son"), tsc(u8"Mma"), tsc(u8"Bed"), tsc(u8"Rar"), tsc(u8"Ne"), tsc(u8"Hla"), tsc(u8"Moq")},
             .day = {tsc(u8"Sontaha"), tsc(u8"Mantaha"), tsc(u8"Labobedi"), tsc(u8"Laboraro"), tsc(u8"Labone"),
                     tsc(u8"Labohlano"), tsc(u8"Moqebelo")},
             .abmon = {tsc(u8"Phe"), tsc(u8"Hla"), tsc(u8"TlH"), tsc(u8"Mme"), tsc(u8"Mot"), tsc(u8"Jan"), tsc(u8"Upu"),
                       tsc(u8"Pha"), tsc(u8"Leo"), tsc(u8"Mph"), tsc(u8"Pud"), tsc(u8"Tsh")},
             .mon = {tsc(u8"Pherekgong"), tsc(u8"Hlakola"), tsc(u8"Tlhakubele"), tsc(u8"Mmese"), tsc(u8"Motsheanong"),
                     tsc(u8"Phupjane"), tsc(u8"Phupu"), tsc(u8"Phato"), tsc(u8"Leotse"), tsc(u8"Mphalane"),
                     tsc(u8"Pudungwana"), tsc(u8"Tshitwe")},
    ...
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                ...
                .lang_name = tsc(u8"Sesotho"),
                .lang_ab = tsc(u8"st"),
                .lang_term = tsc(u8"sot"),
                .lang_lib = tsc(u8"sot")},
    .measurement = {.measurement = 1}};
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"st_ZA"),
         ...
         .title = tsc(u"Sotho locale for South Africa"),
    ...
    .time = {.abday = {tsc(u"Son"), tsc(u"Mma"), tsc(u"Bed"), tsc(u"Rar"), tsc(u"Ne"), tsc(u"Hla"), tsc(u"Moq")},
             .day = {tsc(u"Sontaha"), tsc(u"Mantaha"), tsc(u"Labobedi"), tsc(u"Laboraro"), tsc(u"Labone"),
                     tsc(u"Labohlano"), tsc(u"Moqebelo")},
             .abmon = {tsc(u"Phe"), tsc(u"Hla"), tsc(u"TlH"), tsc(u"Mme"), tsc(u"Mot"), tsc(u"Jan"), tsc(u"Upu"),
                       tsc(u"Pha"), tsc(u"Leo"), tsc(u"Mph"), tsc(u"Pud"), tsc(u"Tsh")},
             .mon = {tsc(u"Pherekgong"), tsc(u"Hlakola"), tsc(u"Tlhakubele"), tsc(u"Mmese"), tsc(u"Motsheanong"),
                     tsc(u"Phupjane"), tsc(u"Phupu"), tsc(u"Phato"), tsc(u"Leotse"), tsc(u"Mphalane"),
                     tsc(u"Pudungwana"), tsc(u"Tshitwe")},
