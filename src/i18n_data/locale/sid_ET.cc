...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("sid_ET"),
         ...
         .title = tsc("Sidama language locale for Ethiopia."),
    ...
    .time = {.abday = {tsc("Sam"), tsc("San"), tsc("Mak"), tsc("Row"), tsc("Ham"), tsc("Arb"), tsc("Qid")},
             .day = {tsc("Sambata"), tsc("Sanyo"), tsc("Maakisanyo"), tsc("Roowe"), tsc("Hamuse"), tsc("Arbe"),
                     tsc("Qidaame")},
    ...
    .address = {.postal_fmt = tsc("%z%c%T%s%b%e%r"),
                .country_name = tsc("Itiyoophiya"),
                .country_post = tsc("ETH"),
                .country_ab2 = tsc("ET"),
                .country_ab3 = tsc("ETH"),
                .country_num = 231,
                .country_car = tsc("ETH"),
                .lang_name = tsc("Sidaamu Afo"),
                .lang_term = tsc("sid"),
                .lang_lib = tsc("sid")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"sid_ET"),
         ...
         .title = tsc(L"Sidama language locale for Ethiopia."),
    ...
    .time = {.abday = {tsc(L"Sam"), tsc(L"San"), tsc(L"Mak"), tsc(L"Row"), tsc(L"Ham"), tsc(L"Arb"), tsc(L"Qid")},
             .day = {tsc(L"Sambata"), tsc(L"Sanyo"), tsc(L"Maakisanyo"), tsc(L"Roowe"), tsc(L"Hamuse"), tsc(L"Arbe"),
                     tsc(L"Qidaame")},
             ...
             .am_pm = {tsc(L"soodo"), tsc(L"hawwaro")},
             .week = {7, 19971130, 1}},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"sid_ET"),
         ...
         .title = tsc(u8"Sidama language locale for Ethiopia."),
    ...
    .time = {.abday = {tsc(u8"Sam"), tsc(u8"San"), tsc(u8"Mak"), tsc(u8"Row"), tsc(u8"Ham"), tsc(u8"Arb"),
                       tsc(u8"Qid")},
             .day = {tsc(u8"Sambata"), tsc(u8"Sanyo"), tsc(u8"Maakisanyo"), tsc(u8"Roowe"), tsc(u8"Hamuse"),
                     tsc(u8"Arbe"), tsc(u8"Qidaame")},
             ...
             .am_pm = {tsc(u8"soodo"), tsc(u8"hawwaro")},
             .week = {7, 19971130, 1}},
    ...
    .name = {.name_fmt = tsc(u8"%d%t%g%t%m%t%f"),
             .name_gen = tsc(u8""),
             .name_miss = tsc(u8"Beeto"),
             .name_mr = tsc(u8"Kalaa"),
             .name_mrs = tsc(u8"Dukko"),
             .name_ms = tsc(u8"")},
    .address = {.postal_fmt = tsc(u8"%z%c%T%s%b%e%r"),
                .country_name = tsc(u8"Itiyoophiya"),
                .country_post = tsc(u8"ETH"),
                .country_ab2 = tsc(u8"ET"),
                .country_ab3 = tsc(u8"ETH"),
                .country_num = 231,
                .country_car = tsc(u8"ETH"),
                .lang_name = tsc(u8"Sidaamu Afo"),
                .lang_term = tsc(u8"sid"),
                .lang_lib = tsc(u8"sid")},
    .measurement = {.measurement = 1}};
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"sid_ET"),
         ...
         .title = tsc(u"Sidama language locale for Ethiopia."),
    ...
    .time = {.abday = {tsc(u"Sam"), tsc(u"San"), tsc(u"Mak"), tsc(u"Row"), tsc(u"Ham"), tsc(u"Arb"), tsc(u"Qid")},
             .day = {tsc(u"Sambata"), tsc(u"Sanyo"), tsc(u"Maakisanyo"), tsc(u"Roowe"), tsc(u"Hamuse"), tsc(u"Arbe"),
                     tsc(u"Qidaame")},
             ...
             .am_pm = {tsc(u"soodo"), tsc(u"hawwaro")},
             .week = {7, 19971130, 1}},
