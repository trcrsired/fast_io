...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("gez_ER"),
         ...
         .title = tsc("Ge'ez language locale for Eritrea."),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"gez_ER"),
         ...
         .title = tsc(L"Ge'ez language locale for Eritrea."),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"gez_ER"),
         ...
         .title = tsc(u8"Ge'ez language locale for Eritrea."),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"gez_ER"),
         ...
         .title = tsc(u"Ge'ez language locale for Eritrea."),
