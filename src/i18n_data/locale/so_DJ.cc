...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("so_DJ"),
         ...
         .title = tsc("Somali language locale for Djibouti."),
    ...
    .time = {.abday = {tsc("Axd"), tsc("Isn"), tsc("Tal"), tsc("Arb"), tsc("Kha"), tsc("Jim"), tsc("Sab")},
             ...
             .week = {7, 19971130, 1},
             .first_weekday = 7},
    .messages = {.yesexpr = tsc("^[+1oOyY]"), .noexpr = tsc("^[-0nN]"), .yesstr = tsc("haa"), .nostr = tsc("maya")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"so_DJ"),
         ...
         .title = tsc(L"Somali language locale for Djibouti."),
    ...
    .time = {.abday = {tsc(L"Axd"), tsc(L"Isn"), tsc(L"Tal"), tsc(L"Arb"), tsc(L"Kha"), tsc(L"Jim"), tsc(L"Sab")},
             ...
             .week = {7, 19971130, 1},
             .first_weekday = 7},
    .messages = {.yesexpr = tsc(L"^[+1oOyY]"), .noexpr = tsc(L"^[-0nN]"), .yesstr = tsc(L"haa"), .nostr = tsc(L"maya")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"so_DJ"),
         ...
         .title = tsc(u8"Somali language locale for Djibouti."),
    ...
    .time = {.abday = {tsc(u8"Axd"), tsc(u8"Isn"), tsc(u8"Tal"), tsc(u8"Arb"), tsc(u8"Kha"), tsc(u8"Jim"),
                       tsc(u8"Sab")},
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"so_DJ"),
         ...
         .title = tsc(u"Somali language locale for Djibouti."),
    ...
    .time = {.abday = {tsc(u"Axd"), tsc(u"Isn"), tsc(u"Tal"), tsc(u"Arb"), tsc(u"Kha"), tsc(u"Jim"), tsc(u"Sab")},
             ...
             .week = {7, 19971130, 1},
             .first_weekday = 7},
    .messages = {.yesexpr = tsc(u"^[+1oOyY]"), .noexpr = tsc(u"^[-0nN]"), .yesstr = tsc(u"haa"), .nostr = tsc(u"maya")},
    .paper = {.width = 210, .height = 297},
