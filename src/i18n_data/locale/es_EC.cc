...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("es_EC"),
         ...
         .title = tsc("Spanish locale for Ecuador"),
    ...
    .telephone = {.tel_int_fmt = tsc("+%c %a %l"), .int_select = tsc("00"), .int_prefix = tsc("593")},
    .name = {.name_fmt = tsc("%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc("%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc("Ecuador"),
                .country_ab2 = tsc("EC"),
                .country_ab3 = tsc("ECU"),
                .country_num = 218,
                .country_car = tsc("EC"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"es_EC"),
         ...
         .title = tsc(L"Spanish locale for Ecuador"),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(L"+%c %a %l"), .int_select = tsc(L"00"), .int_prefix = tsc(L"593")},
    .name = {.name_fmt = tsc(L"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(L"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(L"Ecuador"),
                .country_ab2 = tsc(L"EC"),
                .country_ab3 = tsc(L"ECU"),
                .country_num = 218,
                .country_car = tsc(L"EC"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"es_EC"),
         ...
         .title = tsc(u8"Spanish locale for Ecuador"),
    ...
    .messages = {.yesexpr = tsc(u8"^[+1sSyY]"),
                 ...
                 .nostr = tsc(u8"no")},
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(u8"+%c %a %l"), .int_select = tsc(u8"00"), .int_prefix = tsc(u8"593")},
    .name = {.name_fmt = tsc(u8"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u8"Ecuador"),
                .country_ab2 = tsc(u8"EC"),
                .country_ab3 = tsc(u8"ECU"),
                .country_num = 218,
                .country_car = tsc(u8"EC"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"es_EC"),
         ...
         .title = tsc(u"Spanish locale for Ecuador"),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(u"+%c %a %l"), .int_select = tsc(u"00"), .int_prefix = tsc(u"593")},
    .name = {.name_fmt = tsc(u"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u"Ecuador"),
                .country_ab2 = tsc(u"EC"),
                .country_ab3 = tsc(u"ECU"),
                .country_num = 218,
                .country_car = tsc(u"EC"),
