...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("es_SV"),
         ...
         .title = tsc("Spanish locale for El Salvador"),
    ...
    .telephone = {.tel_int_fmt = tsc("+%c %a %l"), .int_select = tsc("00"), .int_prefix = tsc("503")},
    .name = {.name_fmt = tsc("%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc("%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc("El Salvador"),
                .country_ab2 = tsc("SV"),
                .country_ab3 = tsc("SLV"),
                .country_num = 222,
                .country_car = tsc("ES"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"es_SV"),
         ...
         .title = tsc(L"Spanish locale for El Salvador"),
    ...
    .paper = {.width = 216, .height = 279},
    .telephone = {.tel_int_fmt = tsc(L"+%c %a %l"), .int_select = tsc(L"00"), .int_prefix = tsc(L"503")},
    .name = {.name_fmt = tsc(L"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(L"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(L"El Salvador"),
                .country_ab2 = tsc(L"SV"),
                .country_ab3 = tsc(L"SLV"),
                .country_num = 222,
                .country_car = tsc(L"ES"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"es_SV"),
         ...
         .title = tsc(u8"Spanish locale for El Salvador"),
    ...
    .messages = {.yesexpr = tsc(u8"^[+1sSyY]"),
                 ...
                 .nostr = tsc(u8"no")},
    .paper = {.width = 216, .height = 279},
    .telephone = {.tel_int_fmt = tsc(u8"+%c %a %l"), .int_select = tsc(u8"00"), .int_prefix = tsc(u8"503")},
    .name = {.name_fmt = tsc(u8"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u8"El Salvador"),
                .country_ab2 = tsc(u8"SV"),
                .country_ab3 = tsc(u8"SLV"),
                .country_num = 222,
                .country_car = tsc(u8"ES"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"es_SV"),
         ...
         .title = tsc(u"Spanish locale for El Salvador"),
    ...
    .paper = {.width = 216, .height = 279},
    .telephone = {.tel_int_fmt = tsc(u"+%c %a %l"), .int_select = tsc(u"00"), .int_prefix = tsc(u"503")},
    .name = {.name_fmt = tsc(u"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u"El Salvador"),
                .country_ab2 = tsc(u"SV"),
                .country_ab3 = tsc(u"SLV"),
                .country_num = 222,
                .country_car = tsc(u"ES"),
