...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("om_ET"),
         ...
         .title = tsc("Oromo language locale for Ethiopia."),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"om_ET"),
         ...
         .title = tsc(L"Oromo language locale for Ethiopia."),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"om_ET"),
         ...
         .title = tsc(u8"Oromo language locale for Ethiopia."),
    ...
    .address = {.postal_fmt = tsc(u8"%z%c%T%s%b%e%r"),
                .country_name = tsc(u8"Itoophiyaa"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"om_ET"),
         ...
         .title = tsc(u"Oromo language locale for Ethiopia."),
