...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("en_HK"),
         ...
         .title = tsc("English locale for Hong Kong"),
    ...
    .time = {.abday = {tsc("Sun"), tsc("Mon"), tsc("Tue"), tsc("Wed"), tsc("Thu"), tsc("Fri"), tsc("Sat")},
             ...
             .d_t_fmt = tsc("%A, %B %d, %Y %p%I:%M:%S"),
             .d_fmt = tsc("%A, %B %d, %Y"),
             .t_fmt = tsc("%I:%M:%S %p %Z"),
             .t_fmt_ampm = tsc("%I:%M:%S %p %Z"),
             .date_fmt = tsc("%A, %B %d, %Y %p%I:%M:%S %Z"),
             .am_pm = {tsc("AM"), tsc("PM")},
             .week = {7, 19971130, 1}},
    ...
    .address = {.postal_fmt = tsc("%z%c%T%s%b%e%r"),
                .country_name = tsc("Hong Kong SAR China"),
                .country_ab2 = tsc("HK"),
                .country_ab3 = tsc("HKG"),
                .country_num = 344,
                .country_car = tsc("HK"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"en_HK"),
         ...
         .title = tsc(L"English locale for Hong Kong"),
    ...
    .time = {.abday = {tsc(L"Sun"), tsc(L"Mon"), tsc(L"Tue"), tsc(L"Wed"), tsc(L"Thu"), tsc(L"Fri"), tsc(L"Sat")},
             ...
             .mon = {tsc(L"January"), tsc(L"February"), tsc(L"March"), tsc(L"April"), tsc(L"May"), tsc(L"June"),
                     ...
                     tsc(L"December")},
             .d_t_fmt = tsc(L"%A, %B %d, %Y %p%I:%M:%S"),
             .d_fmt = tsc(L"%A, %B %d, %Y"),
             .t_fmt = tsc(L"%I:%M:%S %p %Z"),
             .t_fmt_ampm = tsc(L"%I:%M:%S %p %Z"),
             .date_fmt = tsc(L"%A, %B %d, %Y %p%I:%M:%S %Z"),
    ...
    .address = {.postal_fmt = tsc(L"%z%c%T%s%b%e%r"),
                .country_name = tsc(L"Hong Kong SAR China"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"en_HK"),
         ...
         .title = tsc(u8"English locale for Hong Kong"),
    ...
    .time = {.abday = {tsc(u8"Sun"), tsc(u8"Mon"), tsc(u8"Tue"), tsc(u8"Wed"), tsc(u8"Thu"), tsc(u8"Fri"),
             ...
             .mon = {tsc(u8"January"), tsc(u8"February"), tsc(u8"March"), tsc(u8"April"), tsc(u8"May"), tsc(u8"June"),
                     ...
                     tsc(u8"December")},
             .d_t_fmt = tsc(u8"%A, %B %d, %Y %p%I:%M:%S"),
             .d_fmt = tsc(u8"%A, %B %d, %Y"),
             .t_fmt = tsc(u8"%I:%M:%S %p %Z"),
             .t_fmt_ampm = tsc(u8"%I:%M:%S %p %Z"),
             .date_fmt = tsc(u8"%A, %B %d, %Y %p%I:%M:%S %Z"),
    ...
    .address = {.postal_fmt = tsc(u8"%z%c%T%s%b%e%r"),
                .country_name = tsc(u8"Hong Kong SAR China"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"en_HK"),
         ...
         .title = tsc(u"English locale for Hong Kong"),
    ...
    .time = {.abday = {tsc(u"Sun"), tsc(u"Mon"), tsc(u"Tue"), tsc(u"Wed"), tsc(u"Thu"), tsc(u"Fri"), tsc(u"Sat")},
             ...
             .mon = {tsc(u"January"), tsc(u"February"), tsc(u"March"), tsc(u"April"), tsc(u"May"), tsc(u"June"),
                     ...
                     tsc(u"December")},
             .d_t_fmt = tsc(u"%A, %B %d, %Y %p%I:%M:%S"),
             .d_fmt = tsc(u"%A, %B %d, %Y"),
             .t_fmt = tsc(u"%I:%M:%S %p %Z"),
             .t_fmt_ampm = tsc(u"%I:%M:%S %p %Z"),
             .date_fmt = tsc(u"%A, %B %d, %Y %p%I:%M:%S %Z"),
    ...
    .address = {.postal_fmt = tsc(u"%z%c%T%s%b%e%r"),
                .country_name = tsc(u"Hong Kong SAR China"),
