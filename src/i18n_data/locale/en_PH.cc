...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("en_PH"),
         ...
         .title = tsc("English language locale for Philippines"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"en_PH"),
         ...
         .title = tsc(L"English language locale for Philippines"),
    ...
    .address = {.postal_fmt = tsc(L"%z%c%T%s%b%e%r"),
                .country_name = tsc(L"Philippines"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"en_PH"),
         ...
         .title = tsc(u8"English language locale for Philippines"),
    ...
    .address = {.postal_fmt = tsc(u8"%z%c%T%s%b%e%r"),
                .country_name = tsc(u8"Philippines"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"en_PH"),
         ...
         .title = tsc(u"English language locale for Philippines"),
    ...
    .address = {.postal_fmt = tsc(u"%z%c%T%s%b%e%r"),
                .country_name = tsc(u"Philippines"),
