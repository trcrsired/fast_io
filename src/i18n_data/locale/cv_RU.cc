...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("cv_RU"),
         ...
         .title = tsc("Chuvash locale for Russia"),
    ...
    .time = {.abday = {tsc("vr"), tsc("tn"), tsc("yt"), tsc("jn"), tsc("kş"), tsc("er"), tsc("šm")},
             .day = {tsc("vyrsarnikun"), tsc("tuntikun"), tsc("ytlarikun"), tsc("junkun"), tsc("kĕşnernikun"),
                     tsc("ernekun"), tsc("šămatkun")},
             .abmon = {tsc("KĂR"), tsc("NAR"), tsc("PUŠ"), tsc("AKA"), tsc("ŞU"), tsc("ŞĔR"), tsc("UTĂ"), tsc("ŞUR"),
                       tsc("AVĂ"), tsc("JUP"), tsc("CÜK"), tsc("RAŠ")},
             .mon = {tsc("kărlac"), tsc("narăs"), tsc("puš"), tsc("aka"), tsc("şu"), tsc("şĕrtme"), tsc("ută"),
                     tsc("şurla"), tsc("avăn"), tsc("jupa"), tsc("cük"), tsc("raštav")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"cv_RU"),
         ...
         .title = tsc(L"Chuvash locale for Russia"),
    ...
    .time = {.abday = {tsc(L"vr"), tsc(L"tn"), tsc(L"yt"), tsc(L"jn"), tsc(L"kş"), tsc(L"er"), tsc(L"šm")},
             .day = {tsc(L"vyrsarnikun"), tsc(L"tuntikun"), tsc(L"ytlarikun"), tsc(L"junkun"), tsc(L"kĕşnernikun"),
                     tsc(L"ernekun"), tsc(L"šămatkun")},
             .abmon = {tsc(L"KĂR"), tsc(L"NAR"), tsc(L"PUŠ"), tsc(L"AKA"), tsc(L"ŞU"), tsc(L"ŞĔR"), tsc(L"UTĂ"),
                       tsc(L"ŞUR"), tsc(L"AVĂ"), tsc(L"JUP"), tsc(L"CÜK"), tsc(L"RAŠ")},
             .mon = {tsc(L"kărlac"), tsc(L"narăs"), tsc(L"puš"), tsc(L"aka"), tsc(L"şu"), tsc(L"şĕrtme"), tsc(L"ută"),
                     tsc(L"şurla"), tsc(L"avăn"), tsc(L"jupa"), tsc(L"cük"), tsc(L"raštav")},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"cv_RU"),
         ...
         .title = tsc(u8"Chuvash locale for Russia"),
    ...
    .time = {.abday = {tsc(u8"vr"), tsc(u8"tn"), tsc(u8"yt"), tsc(u8"jn"), tsc(u8"kş"), tsc(u8"er"), tsc(u8"šm")},
             .day = {tsc(u8"vyrsarnikun"), tsc(u8"tuntikun"), tsc(u8"ytlarikun"), tsc(u8"junkun"), tsc(u8"kĕşnernikun"),
                     tsc(u8"ernekun"), tsc(u8"šămatkun")},
             .abmon = {tsc(u8"KĂR"), tsc(u8"NAR"), tsc(u8"PUŠ"), tsc(u8"AKA"), tsc(u8"ŞU"), tsc(u8"ŞĔR"), tsc(u8"UTĂ"),
                       tsc(u8"ŞUR"), tsc(u8"AVĂ"), tsc(u8"JUP"), tsc(u8"CÜK"), tsc(u8"RAŠ")},
             .mon = {tsc(u8"kărlac"), tsc(u8"narăs"), tsc(u8"puš"), tsc(u8"aka"), tsc(u8"şu"), tsc(u8"şĕrtme"),
                     tsc(u8"ută"), tsc(u8"şurla"), tsc(u8"avăn"), tsc(u8"jupa"), tsc(u8"cük"), tsc(u8"raštav")},
    ...
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                ...
                .lang_name = tsc(u8"Чӑвашла"),
                .lang_ab = tsc(u8"cv"),
                .lang_term = tsc(u8"chv"),
                .lang_lib = tsc(u8"chv")},
    .measurement = {.measurement = 1}};
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"cv_RU"),
         ...
         .title = tsc(u"Chuvash locale for Russia"),
    ...
    .time = {.abday = {tsc(u"vr"), tsc(u"tn"), tsc(u"yt"), tsc(u"jn"), tsc(u"kş"), tsc(u"er"), tsc(u"šm")},
             .day = {tsc(u"vyrsarnikun"), tsc(u"tuntikun"), tsc(u"ytlarikun"), tsc(u"junkun"), tsc(u"kĕşnernikun"),
                     tsc(u"ernekun"), tsc(u"šămatkun")},
             .abmon = {tsc(u"KĂR"), tsc(u"NAR"), tsc(u"PUŠ"), tsc(u"AKA"), tsc(u"ŞU"), tsc(u"ŞĔR"), tsc(u"UTĂ"),
                       tsc(u"ŞUR"), tsc(u"AVĂ"), tsc(u"JUP"), tsc(u"CÜK"), tsc(u"RAŠ")},
             .mon = {tsc(u"kărlac"), tsc(u"narăs"), tsc(u"puš"), tsc(u"aka"), tsc(u"şu"), tsc(u"şĕrtme"), tsc(u"ută"),
                     tsc(u"şurla"), tsc(u"avăn"), tsc(u"jupa"), tsc(u"cük"), tsc(u"raštav")},
