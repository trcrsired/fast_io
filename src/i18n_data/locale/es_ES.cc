...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("es_ES"),
         ...
         .title = tsc("Spanish locale for Spain"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"es_ES"),
         ...
         .title = tsc(L"Spanish locale for Spain"),
         ...
         .tel = tsc(L""),
         .fax = tsc(L""),
         .language = tsc(L"European Spanish"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"es_ES"),
         ...
         .title = tsc(u8"Spanish locale for Spain"),
         ...
         .tel = tsc(u8""),
         .fax = tsc(u8""),
         .language = tsc(u8"European Spanish"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"es_ES"),
         ...
         .title = tsc(u"Spanish locale for Spain"),
         ...
         .tel = tsc(u""),
         .fax = tsc(u""),
         .language = tsc(u"European Spanish"),
