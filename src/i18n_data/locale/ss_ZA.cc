...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("ss_ZA"),
         ...
         .title = tsc("Swati locale for South Africa"),
    ...
    .time = {.abday = {tsc("Son"), tsc("Mso"), tsc("Bil"), tsc("Tsa"), tsc("Ne"), tsc("Hla"), tsc("Mgc")},
             .day = {tsc("Lisontfo"), tsc("uMsombuluko"), tsc("Lesibili"), tsc("Lesitsatfu"), tsc("Lesine"),
                     tsc("Lesihlanu"), tsc("uMgcibelo")},
             .abmon = {tsc("Bhi"), tsc("Van"), tsc("Vul"), tsc("Mab"), tsc("Khk"), tsc("Nhl"), tsc("Kho"), tsc("Ngc"),
                       tsc("Nyo"), tsc("Imp"), tsc("Lwe"), tsc("Ngo")},
             .mon = {tsc("Bhimbidvwane"), tsc("iNdlovane"), tsc("iNdlovulenkhulu"), tsc("Mabasa"), tsc("Inkhwenkhweti"),
                     tsc("iNhlaba"), tsc("Kholwane"), tsc("iNgci"), tsc("iNyoni"), tsc("Impala"), tsc("Lweti"),
                     tsc("iNgongoni")},
             ...
             .am_pm = {tsc(""), tsc("")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc("^[+1yY]"), .noexpr = tsc("^[-0nNaA]")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"ss_ZA"),
         ...
         .title = tsc(L"Swati locale for South Africa"),
    ...
    .time = {.abday = {tsc(L"Son"), tsc(L"Mso"), tsc(L"Bil"), tsc(L"Tsa"), tsc(L"Ne"), tsc(L"Hla"), tsc(L"Mgc")},
             .day = {tsc(L"Lisontfo"), tsc(L"uMsombuluko"), tsc(L"Lesibili"), tsc(L"Lesitsatfu"), tsc(L"Lesine"),
                     tsc(L"Lesihlanu"), tsc(L"uMgcibelo")},
             .abmon = {tsc(L"Bhi"), tsc(L"Van"), tsc(L"Vul"), tsc(L"Mab"), tsc(L"Khk"), tsc(L"Nhl"), tsc(L"Kho"),
                       tsc(L"Ngc"), tsc(L"Nyo"), tsc(L"Imp"), tsc(L"Lwe"), tsc(L"Ngo")},
             .mon = {tsc(L"Bhimbidvwane"), tsc(L"iNdlovane"), tsc(L"iNdlovulenkhulu"), tsc(L"Mabasa"),
                     tsc(L"Inkhwenkhweti"), tsc(L"iNhlaba"), tsc(L"Kholwane"), tsc(L"iNgci"), tsc(L"iNyoni"),
                     tsc(L"Impala"), tsc(L"Lweti"), tsc(L"iNgongoni")},
             ...
             .am_pm = {tsc(L""), tsc(L"")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc(L"^[+1yY]"), .noexpr = tsc(L"^[-0nNaA]")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"ss_ZA"),
         ...
         .title = tsc(u8"Swati locale for South Africa"),
    ...
    .time = {.abday = {tsc(u8"Son"), tsc(u8"Mso"), tsc(u8"Bil"), tsc(u8"Tsa"), tsc(u8"Ne"), tsc(u8"Hla"), tsc(u8"Mgc")},
             .day = {tsc(u8"Lisontfo"), tsc(u8"uMsombuluko"), tsc(u8"Lesibili"), tsc(u8"Lesitsatfu"), tsc(u8"Lesine"),
                     tsc(u8"Lesihlanu"), tsc(u8"uMgcibelo")},
             .abmon = {tsc(u8"Bhi"), tsc(u8"Van"), tsc(u8"Vul"), tsc(u8"Mab"), tsc(u8"Khk"), tsc(u8"Nhl"), tsc(u8"Kho"),
                       tsc(u8"Ngc"), tsc(u8"Nyo"), tsc(u8"Imp"), tsc(u8"Lwe"), tsc(u8"Ngo")},
             .mon = {tsc(u8"Bhimbidvwane"), tsc(u8"iNdlovane"), tsc(u8"iNdlovulenkhulu"), tsc(u8"Mabasa"),
                     tsc(u8"Inkhwenkhweti"), tsc(u8"iNhlaba"), tsc(u8"Kholwane"), tsc(u8"iNgci"), tsc(u8"iNyoni"),
                     tsc(u8"Impala"), tsc(u8"Lweti"), tsc(u8"iNgongoni")},
             ...
             .am_pm = {tsc(u8""), tsc(u8"")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc(u8"^[+1yY]"), .noexpr = tsc(u8"^[-0nNaA]")},
    .paper = {.width = 210, .height = 297},
    ...
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                ...
                .lang_name = tsc(u8"siSwati"),
                .lang_ab = tsc(u8"ss"),
                .lang_term = tsc(u8"ssw"),
                .lang_lib = tsc(u8"ssw")},
    .measurement = {.measurement = 1}};
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"ss_ZA"),
         ...
         .title = tsc(u"Swati locale for South Africa"),
    ...
    .time = {.abday = {tsc(u"Son"), tsc(u"Mso"), tsc(u"Bil"), tsc(u"Tsa"), tsc(u"Ne"), tsc(u"Hla"), tsc(u"Mgc")},
             .day = {tsc(u"Lisontfo"), tsc(u"uMsombuluko"), tsc(u"Lesibili"), tsc(u"Lesitsatfu"), tsc(u"Lesine"),
                     tsc(u"Lesihlanu"), tsc(u"uMgcibelo")},
             .abmon = {tsc(u"Bhi"), tsc(u"Van"), tsc(u"Vul"), tsc(u"Mab"), tsc(u"Khk"), tsc(u"Nhl"), tsc(u"Kho"),
                       tsc(u"Ngc"), tsc(u"Nyo"), tsc(u"Imp"), tsc(u"Lwe"), tsc(u"Ngo")},
             .mon = {tsc(u"Bhimbidvwane"), tsc(u"iNdlovane"), tsc(u"iNdlovulenkhulu"), tsc(u"Mabasa"),
                     tsc(u"Inkhwenkhweti"), tsc(u"iNhlaba"), tsc(u"Kholwane"), tsc(u"iNgci"), tsc(u"iNyoni"),
                     tsc(u"Impala"), tsc(u"Lweti"), tsc(u"iNgongoni")},
             ...
             .am_pm = {tsc(u""), tsc(u"")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc(u"^[+1yY]"), .noexpr = tsc(u"^[-0nNaA]")},
    .paper = {.width = 210, .height = 297},
