...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("os_RU"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("Ossetian locale for Russia"),
                       .source = tsc("fast_io"),
                       .address =
    ...
    .time = {.abday = {tsc("Хцб"), tsc("Крс"), tsc("Дцг"), tsc("Æрт"), tsc("Цпр"), tsc("Мрб"), tsc("Сбт")},
             .day = {tsc("Хуыцаубон"), tsc("Къуырисæр"), tsc("Дыццæг"), tsc("Æртыццæг"), tsc("Цыппæрæм"),
                     tsc("Майрæмбон"), tsc("Сабат")},
             .abmon = {tsc("Янв"), tsc("Фев"), tsc("Мар"), tsc("Апр"), tsc("Май"), tsc("Июн"), tsc("Июл"), tsc("Авг"),
                       tsc("Сен"), tsc("Окт"), tsc("Ноя"), tsc("Дек")},
             .mon = {tsc("январы"), tsc("февралы"), tsc("мартъийы"), tsc("апрелы"), tsc("майы"), tsc("июны"),
                     tsc("июлы"), tsc("августы"), tsc("сентябры"), tsc("октябры"), tsc("ноябры"), tsc("декабры")},
             ...
             .week = {7, 19971130, 1},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc("^[+1yYуУ]"), .noexpr = tsc("^[-0nNнН]"), .yesstr = tsc("уойы"), .nostr = tsc("нӕйы")},
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"os_RU"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"Ossetian locale for Russia"),
    ...
    .time = {.abday = {tsc(L"Хцб"), tsc(L"Крс"), tsc(L"Дцг"), tsc(L"Æрт"), tsc(L"Цпр"), tsc(L"Мрб"), tsc(L"Сбт")},
             .day = {tsc(L"Хуыцаубон"), tsc(L"Къуырисæр"), tsc(L"Дыццæг"), tsc(L"Æртыццæг"), tsc(L"Цыппæрæм"),
                     tsc(L"Майрæмбон"), tsc(L"Сабат")},
             ...
             .mon = {tsc(L"январы"), tsc(L"февралы"), tsc(L"мартъийы"), tsc(L"апрелы"), tsc(L"майы"), tsc(L"июны"),
                     tsc(L"июлы"), tsc(L"августы"), tsc(L"сентябры"), tsc(L"октябры"), tsc(L"ноябры"), tsc(L"декабры")},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"os_RU"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"Ossetian locale for Russia"),
    ...
    .time = {.abday = {tsc(u8"Хцб"), tsc(u8"Крс"), tsc(u8"Дцг"), tsc(u8"Æрт"), tsc(u8"Цпр"), tsc(u8"Мрб"),
                       tsc(u8"Сбт")},
             .day = {tsc(u8"Хуыцаубон"), tsc(u8"Къуырисæр"), tsc(u8"Дыццæг"), tsc(u8"Æртыццæг"), tsc(u8"Цыппæрæм"),
                     tsc(u8"Майрæмбон"), tsc(u8"Сабат")},
             ...
             .mon = {tsc(u8"январы"), tsc(u8"февралы"), tsc(u8"мартъийы"), tsc(u8"апрелы"), tsc(u8"майы"),
                     tsc(u8"июны"), tsc(u8"июлы"), tsc(u8"августы"), tsc(u8"сентябры"), tsc(u8"октябры"),
                     tsc(u8"ноябры"), tsc(u8"декабры")},
...
inline constexpr u16lc_all u16lc_all_global{
    ...
    .time = {.abday = {tsc(u"Хцб"), tsc(u"Крс"), tsc(u"Дцг"), tsc(u"Æрт"), tsc(u"Цпр"), tsc(u"Мрб"), tsc(u"Сбт")},
             .day = {tsc(u"Хуыцаубон"), tsc(u"Къуырисæр"), tsc(u"Дыццæг"), tsc(u"Æртыццæг"), tsc(u"Цыппæрæм"),
                     tsc(u"Майрæмбон"), tsc(u"Сабат")},
             ...
             .mon = {tsc(u"январы"), tsc(u"февралы"), tsc(u"мартъийы"), tsc(u"апрелы"), tsc(u"майы"), tsc(u"июны"),
                     tsc(u"июлы"), tsc(u"августы"), tsc(u"сентябры"), tsc(u"октябры"), tsc(u"ноябры"), tsc(u"декабры")},
