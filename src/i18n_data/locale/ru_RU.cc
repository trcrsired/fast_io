...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("ru_RU"),
         ...
         .title = tsc("Russian locale for Russia"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"ru_RU"),
         ...
         .title = tsc(L"Russian locale for Russia"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"ru_RU"),
         ...
         .title = tsc(u8"Russian locale for Russia"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"ru_RU"),
         ...
         .title = tsc(u"Russian locale for Russia"),
