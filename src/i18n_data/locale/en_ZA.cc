...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("en_ZA"),
         ...
         .title = tsc("English locale for South Africa"),
         ...
         .abbreviation = tsc("Translate.org.za"),
         .revision = tsc("1.3"),
         .date = tsc("2007-04-19")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"en_ZA"),
         ...
         .title = tsc(L"English locale for South Africa"),
         ...
         .abbreviation = tsc(L"Translate.org.za"),
         .revision = tsc(L"1.3"),
         .date = tsc(L"2007-04-19")},
    ...
    .address = {.postal_fmt = tsc(L"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(L"South Africa"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"en_ZA"),
         ...
         .title = tsc(u8"English locale for South Africa"),
         ...
         .abbreviation = tsc(u8"Translate.org.za"),
         .revision = tsc(u8"1.3"),
         .date = tsc(u8"2007-04-19")},
    ...
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u8"South Africa"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"en_ZA"),
         ...
         .title = tsc(u"English locale for South Africa"),
         ...
         .abbreviation = tsc(u"Translate.org.za"),
         .revision = tsc(u"1.3"),
         .date = tsc(u"2007-04-19")},
    ...
    .address = {.postal_fmt = tsc(u"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u"South Africa"),
