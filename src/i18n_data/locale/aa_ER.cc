...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("aa_ER"),
         ...
         .title = tsc("Afar language locale for Eritrea (Cadu//Laaqo Dialects)."),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"aa_ER"),
         ...
         .title = tsc(L"Afar language locale for Eritrea (Cadu//Laaqo Dialects)."),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"aa_ER"),
         ...
         .title = tsc(u8"Afar language locale for Eritrea (Cadu//Laaqo Dialects)."),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"aa_ER"),
         ...
         .title = tsc(u"Afar language locale for Eritrea (Cadu//Laaqo Dialects)."),
