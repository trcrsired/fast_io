...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("xh_ZA"),
         ...
         .title = tsc("Xhosa locale for South Africa"),
    ...
    .time = {.abday = {tsc("Caw"), tsc("Mvu"), tsc("Bin"), tsc("Tha"), tsc("Sin"), tsc("Hla"), tsc("Mgq")},
             .day = {tsc("iCawa"), tsc("uMvulo"), tsc("lwesiBini"), tsc("lwesiThathu"), tsc("ulweSine"),
                     tsc("lwesiHlanu"), tsc("uMgqibelo")},
             .abmon = {tsc("Mqu"), tsc("Mdu"), tsc("Kwi"), tsc("Tsh"), tsc("Can"), tsc("Sil"), tsc("Kha"), tsc("Thu"),
                       tsc("Msi"), tsc("Dwa"), tsc("Nka"), tsc("Mng")},
             .mon = {tsc("eyoMqungu"), tsc("eyoMdumba"), tsc("eyoKwindla"), tsc("uTshazimpuzi"), tsc("uCanzibe"),
                     tsc("eyeSilimela"), tsc("eyeKhala"), tsc("eyeThupa"), tsc("eyoMsintsi"), tsc("eyeDwarha"),
                     tsc("eyeNkanga"), tsc("eyoMnga")},
             ...
             .am_pm = {tsc(""), tsc("")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc("^[+1yYeE]"), .noexpr = tsc("^[-0nNhH]"), .yesstr = tsc("ewe"), .nostr = tsc("hayi")},
    ...
    .name = {.name_fmt = tsc("%d%t%g%t%m%t%f"),
             .name_miss = tsc("Nkosazana"),
             .name_mr = tsc("Mnumzana"),
             .name_mrs = tsc("Nkosikazi"),
             .name_ms = tsc("")},
    .address = {.postal_fmt = tsc("%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc("uMzantsi Afrika"),
                .country_post = tsc("ZA"),
                .country_ab2 = tsc("ZA"),
                .country_ab3 = tsc("ZAF"),
                .country_num = 710,
                .country_car = tsc("ZA"),
                .lang_name = tsc("isiXhosa"),
                .lang_ab = tsc("xh"),
                .lang_term = tsc("xho"),
                .lang_lib = tsc("xho")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"xh_ZA"),
         ...
         .title = tsc(L"Xhosa locale for South Africa"),
    ...
    .time = {.abday = {tsc(L"Caw"), tsc(L"Mvu"), tsc(L"Bin"), tsc(L"Tha"), tsc(L"Sin"), tsc(L"Hla"), tsc(L"Mgq")},
             .day = {tsc(L"iCawa"), tsc(L"uMvulo"), tsc(L"lwesiBini"), tsc(L"lwesiThathu"), tsc(L"ulweSine"),
                     tsc(L"lwesiHlanu"), tsc(L"uMgqibelo")},
             .abmon = {tsc(L"Mqu"), tsc(L"Mdu"), tsc(L"Kwi"), tsc(L"Tsh"), tsc(L"Can"), tsc(L"Sil"), tsc(L"Kha"),
                       tsc(L"Thu"), tsc(L"Msi"), tsc(L"Dwa"), tsc(L"Nka"), tsc(L"Mng")},
             .mon = {tsc(L"eyoMqungu"), tsc(L"eyoMdumba"), tsc(L"eyoKwindla"), tsc(L"uTshazimpuzi"), tsc(L"uCanzibe"),
                     tsc(L"eyeSilimela"), tsc(L"eyeKhala"), tsc(L"eyeThupa"), tsc(L"eyoMsintsi"), tsc(L"eyeDwarha"),
                     tsc(L"eyeNkanga"), tsc(L"eyoMnga")},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"xh_ZA"),
         ...
         .title = tsc(u8"Xhosa locale for South Africa"),
    ...
    .time = {.abday = {tsc(u8"Caw"), tsc(u8"Mvu"), tsc(u8"Bin"), tsc(u8"Tha"), tsc(u8"Sin"), tsc(u8"Hla"),
                       tsc(u8"Mgq")},
             .day = {tsc(u8"iCawa"), tsc(u8"uMvulo"), tsc(u8"lwesiBini"), tsc(u8"lwesiThathu"), tsc(u8"ulweSine"),
                     tsc(u8"lwesiHlanu"), tsc(u8"uMgqibelo")},
             .abmon = {tsc(u8"Mqu"), tsc(u8"Mdu"), tsc(u8"Kwi"), tsc(u8"Tsh"), tsc(u8"Can"), tsc(u8"Sil"), tsc(u8"Kha"),
                       tsc(u8"Thu"), tsc(u8"Msi"), tsc(u8"Dwa"), tsc(u8"Nka"), tsc(u8"Mng")},
             .mon = {tsc(u8"eyoMqungu"), tsc(u8"eyoMdumba"), tsc(u8"eyoKwindla"), tsc(u8"uTshazimpuzi"),
                     tsc(u8"uCanzibe"), tsc(u8"eyeSilimela"), tsc(u8"eyeKhala"), tsc(u8"eyeThupa"), tsc(u8"eyoMsintsi"),
                     tsc(u8"eyeDwarha"), tsc(u8"eyeNkanga"), tsc(u8"eyoMnga")},
    ...
    .name = {.name_fmt = tsc(u8"%d%t%g%t%m%t%f"),
             .name_miss = tsc(u8"Nkosazana"),
             .name_mr = tsc(u8"Mnumzana"),
             .name_mrs = tsc(u8"Nkosikazi"),
             .name_ms = tsc(u8"")},
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u8"uMzantsi Afrika"),
                .country_post = tsc(u8"ZA"),
                .country_ab2 = tsc(u8"ZA"),
                .country_ab3 = tsc(u8"ZAF"),
                .country_num = 710,
                .country_car = tsc(u8"ZA"),
                .lang_name = tsc(u8"isiXhosa"),
                .lang_ab = tsc(u8"xh"),
                .lang_term = tsc(u8"xho"),
                .lang_lib = tsc(u8"xho")},
    .measurement = {.measurement = 1}};
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"xh_ZA"),
         ...
         .title = tsc(u"Xhosa locale for South Africa"),
    ...
    .time = {.abday = {tsc(u"Caw"), tsc(u"Mvu"), tsc(u"Bin"), tsc(u"Tha"), tsc(u"Sin"), tsc(u"Hla"), tsc(u"Mgq")},
             .day = {tsc(u"iCawa"), tsc(u"uMvulo"), tsc(u"lwesiBini"), tsc(u"lwesiThathu"), tsc(u"ulweSine"),
                     tsc(u"lwesiHlanu"), tsc(u"uMgqibelo")},
             .abmon = {tsc(u"Mqu"), tsc(u"Mdu"), tsc(u"Kwi"), tsc(u"Tsh"), tsc(u"Can"), tsc(u"Sil"), tsc(u"Kha"),
                       tsc(u"Thu"), tsc(u"Msi"), tsc(u"Dwa"), tsc(u"Nka"), tsc(u"Mng")},
             .mon = {tsc(u"eyoMqungu"), tsc(u"eyoMdumba"), tsc(u"eyoKwindla"), tsc(u"uTshazimpuzi"), tsc(u"uCanzibe"),
                     tsc(u"eyeSilimela"), tsc(u"eyeKhala"), tsc(u"eyeThupa"), tsc(u"eyoMsintsi"), tsc(u"eyeDwarha"),
                     tsc(u"eyeNkanga"), tsc(u"eyoMnga")},
