...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("de_CH"),
         ...
         .title = tsc("German locale for Switzerland"),
         ...
         .tel = tsc(""),
         .fax = tsc(""),
         .language = tsc("Swiss High German"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"de_CH"),
         ...
         .title = tsc(L"German locale for Switzerland"),
         ...
         .tel = tsc(L""),
         .fax = tsc(L""),
         .language = tsc(L"Swiss High German"),
         .territory = tsc(L"Switzerland"),
         .revision = tsc(L"1.0"),
         .date = tsc(L"2007-09-23")},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"de_CH"),
         ...
         .title = tsc(u8"German locale for Switzerland"),
         ...
         .tel = tsc(u8""),
         .fax = tsc(u8""),
         .language = tsc(u8"Swiss High German"),
         .territory = tsc(u8"Switzerland"),
         .revision = tsc(u8"1.0"),
         .date = tsc(u8"2007-09-23")},
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"de_CH"),
         ...
         .title = tsc(u"German locale for Switzerland"),
         ...
         .tel = tsc(u""),
         .fax = tsc(u""),
         .language = tsc(u"Swiss High German"),
         .territory = tsc(u"Switzerland"),
         .revision = tsc(u"1.0"),
         .date = tsc(u"2007-09-23")},
