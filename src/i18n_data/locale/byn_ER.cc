...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("byn_ER"),
         ...
         .title = tsc("Blin language locale for Eritrea"),
    ...
    .time = {.abday = {tsc("ሰ/ቅ"), tsc("ሰኑ"), tsc("ሰሊጝ"), tsc("ለጓ"), tsc("ኣምድ"), tsc("ኣርብ"), tsc("ሰ/ሽ")},
             .day = {tsc("ሰንበር ቅዳዅ"), tsc("ሰኑ"), tsc("ሰሊጝ"), tsc("ለጓ ወሪ ለብዋ"), tsc("ኣምድ"), tsc("ኣርብ"), tsc("ሰንበር ሽጓዅ")},
             .abmon = {tsc("ልደት"), tsc("ካብኽ"), tsc("ክብላ"), tsc("ፋጅኺ"), tsc("ክቢቅ"), tsc("ም/ት"), tsc("ኰር"), tsc("ማርያ"),
                       tsc("ያኸኒ"), tsc("መተሉ"), tsc("ም/ም"), tsc("ተሕሳ")},
             .mon = {tsc("ልደትሪ"), tsc("ካብኽብቲ"), tsc("ክብላ"), tsc("ፋጅኺሪ"), tsc("ክቢቅሪ"), tsc("ምኪኤል ትጓ̅ኒሪ"), tsc("ኰርኩ"),
                     tsc("ማርያም ትሪ"), tsc("ያኸኒ መሳቅለሪ"), tsc("መተሉ"), tsc("ምኪኤል መሽወሪ"), tsc("ተሕሳስሪ")},
             .d_t_fmt = tsc("%A፡ %B %e ግርጋ %Y %r %Z"),
             .d_fmt = tsc("%d//%m//%Y"),
             .t_fmt = tsc("%l:%M:%S %p"),
             .t_fmt_ampm = tsc("%l:%M:%S %p"),
             .date_fmt = tsc("%A፡ %B %e ግርጋ %r %Z %Y ኣድ"),
             .am_pm = {tsc("ፋዱስ ጃብ"), tsc("ፋዱስ ደምቢ")},
             .week = {7, 19971130, 1},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc("^[+1yYእ]"), .noexpr = tsc("^[-0nNነ]"), .yesstr = tsc("እወ"), .nostr = tsc("ነኖእ")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"byn_ER"),
         ...
         .title = tsc(L"Blin language locale for Eritrea"),
    ...
    .time = {.abday = {tsc(L"ሰ/ቅ"), tsc(L"ሰኑ"), tsc(L"ሰሊጝ"), tsc(L"ለጓ"), tsc(L"ኣምድ"), tsc(L"ኣርብ"), tsc(L"ሰ/ሽ")},
             .day = {tsc(L"ሰንበር ቅዳዅ"), tsc(L"ሰኑ"), tsc(L"ሰሊጝ"), tsc(L"ለጓ ወሪ ለብዋ"), tsc(L"ኣምድ"), tsc(L"ኣርብ"),
                     tsc(L"ሰንበር ሽጓዅ")},
             .abmon = {tsc(L"ልደት"), tsc(L"ካብኽ"), tsc(L"ክብላ"), tsc(L"ፋጅኺ"), tsc(L"ክቢቅ"), tsc(L"ም/ት"), tsc(L"ኰር"),
                       tsc(L"ማርያ"), tsc(L"ያኸኒ"), tsc(L"መተሉ"), tsc(L"ም/ም"), tsc(L"ተሕሳ")},
             .mon = {tsc(L"ልደትሪ"), tsc(L"ካብኽብቲ"), tsc(L"ክብላ"), tsc(L"ፋጅኺሪ"), tsc(L"ክቢቅሪ"), tsc(L"ምኪኤል ትጓ̅ኒሪ"),
                     tsc(L"ኰርኩ"), tsc(L"ማርያም ትሪ"), tsc(L"ያኸኒ መሳቅለሪ"), tsc(L"መተሉ"), tsc(L"ምኪኤል መሽወሪ"), tsc(L"ተሕሳስሪ")},
             .d_t_fmt = tsc(L"%A፡ %B %e ግርጋ %Y %r %Z"),
             .d_fmt = tsc(L"%d//%m//%Y"),
             .t_fmt = tsc(L"%l:%M:%S %p"),
             .t_fmt_ampm = tsc(L"%l:%M:%S %p"),
             .date_fmt = tsc(L"%A፡ %B %e ግርጋ %r %Z %Y ኣድ"),
             .am_pm = {tsc(L"ፋዱስ ጃብ"), tsc(L"ፋዱስ ደምቢ")},
             .week = {7, 19971130, 1},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc(L"^[+1yYእ]"), .noexpr = tsc(L"^[-0nNነ]"), .yesstr = tsc(L"እወ"), .nostr = tsc(L"ነኖእ")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"byn_ER"),
         ...
         .title = tsc(u8"Blin language locale for Eritrea"),
         ...
         .tel = tsc(u8""),
         .fax = tsc(u8""),
         .language = tsc(u8"Blin"),
         .territory = tsc(u8"Eritrea"),
         .revision = tsc(u8"0.21"),
         .date = tsc(u8"2003-11-01")},
    ...
    .time = {.abday = {tsc(u8"ሰ/ቅ"), tsc(u8"ሰኑ"), tsc(u8"ሰሊጝ"), tsc(u8"ለጓ"), tsc(u8"ኣምድ"), tsc(u8"ኣርብ"), tsc(u8"ሰ/ሽ")},
             .day = {tsc(u8"ሰንበር ቅዳዅ"), tsc(u8"ሰኑ"), tsc(u8"ሰሊጝ"), tsc(u8"ለጓ ወሪ ለብዋ"), tsc(u8"ኣምድ"), tsc(u8"ኣርብ"),
                     tsc(u8"ሰንበር ሽጓዅ")},
             .abmon = {tsc(u8"ልደት"), tsc(u8"ካብኽ"), tsc(u8"ክብላ"), tsc(u8"ፋጅኺ"), tsc(u8"ክቢቅ"), tsc(u8"ም/ት"), tsc(u8"ኰር"),
                       tsc(u8"ማርያ"), tsc(u8"ያኸኒ"), tsc(u8"መተሉ"), tsc(u8"ም/ም"), tsc(u8"ተሕሳ")},
             .mon = {tsc(u8"ልደትሪ"), tsc(u8"ካብኽብቲ"), tsc(u8"ክብላ"), tsc(u8"ፋጅኺሪ"), tsc(u8"ክቢቅሪ"), tsc(u8"ምኪኤል ትጓ̅ኒሪ"),
                     tsc(u8"ኰርኩ"), tsc(u8"ማርያም ትሪ"), tsc(u8"ያኸኒ መሳቅለሪ"), tsc(u8"መተሉ"), tsc(u8"ምኪኤል መሽወሪ"),
                     tsc(u8"ተሕሳስሪ")},
             .d_t_fmt = tsc(u8"%A፡ %B %e ግርጋ %Y %r %Z"),
             .d_fmt = tsc(u8"%d//%m//%Y"),
             .t_fmt = tsc(u8"%l:%M:%S %p"),
             .t_fmt_ampm = tsc(u8"%l:%M:%S %p"),
             .date_fmt = tsc(u8"%A፡ %B %e ግርጋ %r %Z %Y ኣድ"),
             .am_pm = {tsc(u8"ፋዱስ ጃብ"), tsc(u8"ፋዱስ ደምቢ")},
             .week = {7, 19971130, 1},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc(u8"^[+1yYእ]"),
                 .noexpr = tsc(u8"^[-0nNነ]"),
                 .yesstr = tsc(u8"እወ"),
                 .nostr = tsc(u8"ነኖእ")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"byn_ER"),
         ...
         .title = tsc(u"Blin language locale for Eritrea"),
    ...
    .time = {.abday = {tsc(u"ሰ/ቅ"), tsc(u"ሰኑ"), tsc(u"ሰሊጝ"), tsc(u"ለጓ"), tsc(u"ኣምድ"), tsc(u"ኣርብ"), tsc(u"ሰ/ሽ")},
             .day = {tsc(u"ሰንበር ቅዳዅ"), tsc(u"ሰኑ"), tsc(u"ሰሊጝ"), tsc(u"ለጓ ወሪ ለብዋ"), tsc(u"ኣምድ"), tsc(u"ኣርብ"),
                     tsc(u"ሰንበር ሽጓዅ")},
             .abmon = {tsc(u"ልደት"), tsc(u"ካብኽ"), tsc(u"ክብላ"), tsc(u"ፋጅኺ"), tsc(u"ክቢቅ"), tsc(u"ም/ት"), tsc(u"ኰር"),
                       tsc(u"ማርያ"), tsc(u"ያኸኒ"), tsc(u"መተሉ"), tsc(u"ም/ም"), tsc(u"ተሕሳ")},
             .mon = {tsc(u"ልደትሪ"), tsc(u"ካብኽብቲ"), tsc(u"ክብላ"), tsc(u"ፋጅኺሪ"), tsc(u"ክቢቅሪ"), tsc(u"ምኪኤል ትጓ̅ኒሪ"),
                     tsc(u"ኰርኩ"), tsc(u"ማርያም ትሪ"), tsc(u"ያኸኒ መሳቅለሪ"), tsc(u"መተሉ"), tsc(u"ምኪኤል መሽወሪ"), tsc(u"ተሕሳስሪ")},
             .d_t_fmt = tsc(u"%A፡ %B %e ግርጋ %Y %r %Z"),
             .d_fmt = tsc(u"%d//%m//%Y"),
             .t_fmt = tsc(u"%l:%M:%S %p"),
             .t_fmt_ampm = tsc(u"%l:%M:%S %p"),
             .date_fmt = tsc(u"%A፡ %B %e ግርጋ %r %Z %Y ኣድ"),
             .am_pm = {tsc(u"ፋዱስ ጃብ"), tsc(u"ፋዱስ ደምቢ")},
             .week = {7, 19971130, 1},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc(u"^[+1yYእ]"), .noexpr = tsc(u"^[-0nNነ]"), .yesstr = tsc(u"እወ"), .nostr = tsc(u"ነኖእ")},
    .paper = {.width = 210, .height = 297},
