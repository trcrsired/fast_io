...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("so_KE"),
         ...
         .title = tsc("Somali language locale for Kenya"),
    ...
    .time = {.abday = {tsc("Axd"), tsc("Isn"), tsc("Sal"), tsc("Arb"), tsc("Kha"), tsc("Jim"), tsc("Sab")},
             ...
             .d_t_fmt = tsc("%A, %B %e, %Y %X %Z"),
             .d_fmt = tsc("%d//%m//%Y"),
             .t_fmt = tsc("%T"),
             .t_fmt_ampm = tsc(""),
             .date_fmt = tsc("%A, %B %e, %X %Z %Y"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"so_KE"),
         ...
         .title = tsc(L"Somali language locale for Kenya"),
    ...
    .time = {.abday = {tsc(L"Axd"), tsc(L"Isn"), tsc(L"Sal"), tsc(L"Arb"), tsc(L"Kha"), tsc(L"Jim"), tsc(L"Sab")},
             ...
             .d_t_fmt = tsc(L"%A, %B %e, %Y %X %Z"),
             .d_fmt = tsc(L"%d//%m//%Y"),
             .t_fmt = tsc(L"%T"),
             .t_fmt_ampm = tsc(L""),
             .date_fmt = tsc(L"%A, %B %e, %X %Z %Y"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"so_KE"),
         ...
         .title = tsc(u8"Somali language locale for Kenya"),
    ...
    .time = {.abday = {tsc(u8"Axd"), tsc(u8"Isn"), tsc(u8"Sal"), tsc(u8"Arb"), tsc(u8"Kha"), tsc(u8"Jim"),
             ...
             .d_t_fmt = tsc(u8"%A, %B %e, %Y %X %Z"),
             .d_fmt = tsc(u8"%d//%m//%Y"),
             .t_fmt = tsc(u8"%T"),
             .t_fmt_ampm = tsc(u8""),
             .date_fmt = tsc(u8"%A, %B %e, %X %Z %Y"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"so_KE"),
         ...
         .title = tsc(u"Somali language locale for Kenya"),
    ...
    .time = {.abday = {tsc(u"Axd"), tsc(u"Isn"), tsc(u"Sal"), tsc(u"Arb"), tsc(u"Kha"), tsc(u"Jim"), tsc(u"Sab")},
             ...
             .d_t_fmt = tsc(u"%A, %B %e, %Y %X %Z"),
             .d_fmt = tsc(u"%d//%m//%Y"),
             .t_fmt = tsc(u"%T"),
             .t_fmt_ampm = tsc(u""),
             .date_fmt = tsc(u"%A, %B %e, %X %Z %Y"),
