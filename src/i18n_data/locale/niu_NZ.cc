...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("niu_NZ"),
         ...
         .title = tsc("Niuean (Vagahau Niue) locale for New Zealand"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"niu_NZ"),
         ...
         .title = tsc(L"Niuean (Vagahau Niue) locale for New Zealand"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"niu_NZ"),
         ...
         .title = tsc(u8"Niuean (Vagahau Niue) locale for New Zealand"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"niu_NZ"),
         ...
         .title = tsc(u"Niuean (Vagahau Niue) locale for New Zealand"),
