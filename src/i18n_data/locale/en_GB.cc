...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("en_GB"),
         ...
         .title = tsc("English locale for Britain"),
         ...
         .contact = tsc("Keld Simonsen\t\t;\t\tfast_io"),
         .email = tsc("bug-glibc-locales@gnu.org;euloanty@live.com"),
         .tel = tsc(""),
         .fax = tsc(""),
         .language = tsc("British English"),
    ...
    .address = {.postal_fmt = tsc("%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc("United Kingdom"),
                .country_ab2 = tsc("GB"),
                .country_ab3 = tsc("GBR"),
                .country_num = 826,
                .country_car = tsc("GB"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"en_GB"),
         ...
         .title = tsc(L"English locale for Britain"),
         ...
         .contact = tsc(L"Keld Simonsen\t\t;\t\tfast_io"),
         .email = tsc(L"bug-glibc-locales@gnu.org;euloanty@live.com"),
         .tel = tsc(L""),
         .fax = tsc(L""),
         .language = tsc(L"British English"),
    ...
    .address = {.postal_fmt = tsc(L"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(L"United Kingdom"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"en_GB"),
         ...
         .title = tsc(u8"English locale for Britain"),
         ...
         .contact = tsc(u8"Keld Simonsen\t\t;\t\tfast_io"),
         .email = tsc(u8"bug-glibc-locales@gnu.org;euloanty@live.com"),
         .tel = tsc(u8""),
         .fax = tsc(u8""),
         .language = tsc(u8"British English"),
    ...
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u8"United Kingdom"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"en_GB"),
         ...
         .title = tsc(u"English locale for Britain"),
         ...
         .contact = tsc(u"Keld Simonsen\t\t;\t\tfast_io"),
         .email = tsc(u"bug-glibc-locales@gnu.org;euloanty@live.com"),
         .tel = tsc(u""),
         .fax = tsc(u""),
         .language = tsc(u"British English"),
    ...
    .address = {.postal_fmt = tsc(u"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u"United Kingdom"),
