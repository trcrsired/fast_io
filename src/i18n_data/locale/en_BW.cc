...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("en_BW"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("English locale for Botswana"),
                       ...
                       .territory = tsc("Botswana"),
                       .revision = tsc("1.0"),
                       .date = tsc("2000-06-29")},
    .monetary = {.int_curr_symbol = tsc("BWP "),
                 .currency_symbol = tsc("P"),
    ...
    .telephone = {.tel_int_fmt = tsc("+%c %a %l"), .int_select = tsc("00"), .int_prefix = tsc("267")},
    .name = {.name_fmt = tsc("%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc("%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc("Botswana"),
                .country_ab2 = tsc("BW"),
                .country_ab3 = tsc("BWA"),
                .country_num = 72,
                .country_car = tsc("BW"),
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"en_BW"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"English locale for Botswana"),
                       ...
                       .territory = tsc(L"Botswana"),
                       .revision = tsc(L"1.0"),
                       .date = tsc(L"2000-06-29")},
    .monetary = {.int_curr_symbol = tsc(L"BWP "),
                 .currency_symbol = tsc(L"P"),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(L"+%c %a %l"), .int_select = tsc(L"00"), .int_prefix = tsc(L"267")},
    .name = {.name_fmt = tsc(L"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(L"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(L"Botswana"),
                .country_ab2 = tsc(L"BW"),
                .country_ab3 = tsc(L"BWA"),
                .country_num = 72,
                .country_car = tsc(L"BW"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"en_BW"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"English locale for Botswana"),
                       ...
                       .territory = tsc(u8"Botswana"),
                       .revision = tsc(u8"1.0"),
                       .date = tsc(u8"2000-06-29")},
    .monetary = {.int_curr_symbol = tsc(u8"BWP "),
                 .currency_symbol = tsc(u8"P"),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(u8"+%c %a %l"), .int_select = tsc(u8"00"), .int_prefix = tsc(u8"267")},
    .name = {.name_fmt = tsc(u8"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u8"Botswana"),
                .country_ab2 = tsc(u8"BW"),
                .country_ab3 = tsc(u8"BWA"),
                .country_num = 72,
                .country_car = tsc(u8"BW"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"en_BW"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"English locale for Botswana"),
                       ...
                       .territory = tsc(u"Botswana"),
                       .revision = tsc(u"1.0"),
                       .date = tsc(u"2000-06-29")},
    .monetary = {.int_curr_symbol = tsc(u"BWP "),
                 .currency_symbol = tsc(u"P"),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(u"+%c %a %l"), .int_select = tsc(u"00"), .int_prefix = tsc(u"267")},
    .name = {.name_fmt = tsc(u"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u"Botswana"),
                .country_ab2 = tsc(u"BW"),
                .country_ab3 = tsc(u"BWA"),
                .country_num = 72,
                .country_car = tsc(u"BW"),
