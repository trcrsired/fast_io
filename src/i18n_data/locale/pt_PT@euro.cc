...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("pt_PT@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("Portuguese locale for Portugal with Euro"),
                       ...
                       .tel = tsc(""),
                       .fax = tsc(""),
                       .language = tsc("Portuguese"),
                       .territory = tsc("Portugal"),
                       .revision = tsc("1.0"),
                       .date = tsc("2000-08-20")},
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"pt_PT@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"Portuguese locale for Portugal with Euro"),
                       ...
                       .tel = tsc(L""),
                       .fax = tsc(L""),
                       .language = tsc(L"Portuguese"),
                       .territory = tsc(L"Portugal"),
                       .revision = tsc(L"1.0"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"pt_PT@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"Portuguese locale for Portugal with Euro"),
                       ...
                       .tel = tsc(u8""),
                       .fax = tsc(u8""),
                       .language = tsc(u8"Portuguese"),
                       .territory = tsc(u8"Portugal"),
                       .revision = tsc(u8"1.0"),
    ...
    .telephone = {.tel_int_fmt = tsc(u8"+%c %l"),
                  ...
                  .int_prefix = tsc(u8"351")},
    .name = {.name_fmt = tsc(u8"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u8"Portugal"),
                .country_ab2 = tsc(u8"PT"),
                .country_ab3 = tsc(u8"PRT"),
                .country_num = 620,
                .country_car = tsc(u8"P"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"pt_PT@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"Portuguese locale for Portugal with Euro"),
                       ...
                       .tel = tsc(u""),
                       .fax = tsc(u""),
                       .language = tsc(u"Portuguese"),
                       .territory = tsc(u"Portugal"),
                       .revision = tsc(u"1.0"),
