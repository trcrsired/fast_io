...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("aa_ET"),
         ...
         .title = tsc("Afar language locale for Ethiopia (Cadu//Carra Dialects)."),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"aa_ET"),
         ...
         .title = tsc(L"Afar language locale for Ethiopia (Cadu//Carra Dialects)."),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"aa_ET"),
         ...
         .title = tsc(u8"Afar language locale for Ethiopia (Cadu//Carra Dialects)."),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"aa_ET"),
         ...
         .title = tsc(u"Afar language locale for Ethiopia (Cadu//Carra Dialects)."),
