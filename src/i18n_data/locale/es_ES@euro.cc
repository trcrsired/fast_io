...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("es_ES@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("Spanish locale for Spain with Euro"),
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"es_ES@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"Spanish locale for Spain with Euro"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"es_ES@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"Spanish locale for Spain with Euro"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"es_ES@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"Spanish locale for Spain with Euro"),
