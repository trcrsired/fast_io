...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("tn_ZA"),
         ...
         .title = tsc("Tswana locale for South Africa"),
    ...
    .time = {.abday = {tsc("Tsh"), tsc("Mos"), tsc("Bed"), tsc("Rar"), tsc("Ne"), tsc("Tlh"), tsc("Mat")},
             .day = {tsc("laTshipi"), tsc("Mosupologo"), tsc("Labobedi"), tsc("Laboraro"), tsc("Labone"),
                     tsc("Labotlhano"), tsc("Lamatlhatso")},
             .abmon = {tsc("Fer"), tsc("Tlh"), tsc("Mop"), tsc("Mor"), tsc("Mot"), tsc("See"), tsc("Phu"), tsc("Pha"),
                       tsc("Lwe"), tsc("Dip"), tsc("Ngw"), tsc("Sed")},
             .mon = {tsc("Ferikgong"), tsc("Tlhakole"), tsc("Mopitlwe"), tsc("Moranang"), tsc("Motsheganong"),
                     tsc("Seetebosigo"), tsc("Phukwi"), tsc("Phatwe"), tsc("Lwetse"), tsc("Diphalane"),
                     tsc("Ngwanatsele"), tsc("Sedimonthole")},
             ...
             .am_pm = {tsc(""), tsc("")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc("^[+1yYeE]"), .noexpr = tsc("^[-0nN]")},
    ...
    .address = {.postal_fmt = tsc("%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc("Aforika Borwa"),
                .country_post = tsc("ZA"),
                .country_ab2 = tsc("ZA"),
                .country_ab3 = tsc("ZAF"),
                .country_num = 710,
                .country_car = tsc("ZA"),
                .lang_name = tsc("Setswana"),
                .lang_ab = tsc("tn"),
                .lang_term = tsc("tsn"),
                .lang_lib = tsc("tsn")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"tn_ZA"),
         ...
         .title = tsc(L"Tswana locale for South Africa"),
    ...
    .time = {.abday = {tsc(L"Tsh"), tsc(L"Mos"), tsc(L"Bed"), tsc(L"Rar"), tsc(L"Ne"), tsc(L"Tlh"), tsc(L"Mat")},
             .day = {tsc(L"laTshipi"), tsc(L"Mosupologo"), tsc(L"Labobedi"), tsc(L"Laboraro"), tsc(L"Labone"),
                     tsc(L"Labotlhano"), tsc(L"Lamatlhatso")},
             .abmon = {tsc(L"Fer"), tsc(L"Tlh"), tsc(L"Mop"), tsc(L"Mor"), tsc(L"Mot"), tsc(L"See"), tsc(L"Phu"),
                       tsc(L"Pha"), tsc(L"Lwe"), tsc(L"Dip"), tsc(L"Ngw"), tsc(L"Sed")},
             .mon = {tsc(L"Ferikgong"), tsc(L"Tlhakole"), tsc(L"Mopitlwe"), tsc(L"Moranang"), tsc(L"Motsheganong"),
                     tsc(L"Seetebosigo"), tsc(L"Phukwi"), tsc(L"Phatwe"), tsc(L"Lwetse"), tsc(L"Diphalane"),
                     tsc(L"Ngwanatsele"), tsc(L"Sedimonthole")},
             ...
             .am_pm = {tsc(L""), tsc(L"")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc(L"^[+1yYeE]"), .noexpr = tsc(L"^[-0nN]")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"tn_ZA"),
         ...
         .title = tsc(u8"Tswana locale for South Africa"),
    ...
    .time = {.abday = {tsc(u8"Tsh"), tsc(u8"Mos"), tsc(u8"Bed"), tsc(u8"Rar"), tsc(u8"Ne"), tsc(u8"Tlh"), tsc(u8"Mat")},
             .day = {tsc(u8"laTshipi"), tsc(u8"Mosupologo"), tsc(u8"Labobedi"), tsc(u8"Laboraro"), tsc(u8"Labone"),
                     tsc(u8"Labotlhano"), tsc(u8"Lamatlhatso")},
             .abmon = {tsc(u8"Fer"), tsc(u8"Tlh"), tsc(u8"Mop"), tsc(u8"Mor"), tsc(u8"Mot"), tsc(u8"See"), tsc(u8"Phu"),
                       tsc(u8"Pha"), tsc(u8"Lwe"), tsc(u8"Dip"), tsc(u8"Ngw"), tsc(u8"Sed")},
             .mon = {tsc(u8"Ferikgong"), tsc(u8"Tlhakole"), tsc(u8"Mopitlwe"), tsc(u8"Moranang"), tsc(u8"Motsheganong"),
                     tsc(u8"Seetebosigo"), tsc(u8"Phukwi"), tsc(u8"Phatwe"), tsc(u8"Lwetse"), tsc(u8"Diphalane"),
                     tsc(u8"Ngwanatsele"), tsc(u8"Sedimonthole")},
             ...
             .am_pm = {tsc(u8""), tsc(u8"")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc(u8"^[+1yYeE]"), .noexpr = tsc(u8"^[-0nN]")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"tn_ZA"),
         ...
         .title = tsc(u"Tswana locale for South Africa"),
    ...
    .time = {.abday = {tsc(u"Tsh"), tsc(u"Mos"), tsc(u"Bed"), tsc(u"Rar"), tsc(u"Ne"), tsc(u"Tlh"), tsc(u"Mat")},
             .day = {tsc(u"laTshipi"), tsc(u"Mosupologo"), tsc(u"Labobedi"), tsc(u"Laboraro"), tsc(u"Labone"),
                     tsc(u"Labotlhano"), tsc(u"Lamatlhatso")},
             .abmon = {tsc(u"Fer"), tsc(u"Tlh"), tsc(u"Mop"), tsc(u"Mor"), tsc(u"Mot"), tsc(u"See"), tsc(u"Phu"),
                       tsc(u"Pha"), tsc(u"Lwe"), tsc(u"Dip"), tsc(u"Ngw"), tsc(u"Sed")},
             .mon = {tsc(u"Ferikgong"), tsc(u"Tlhakole"), tsc(u"Mopitlwe"), tsc(u"Moranang"), tsc(u"Motsheganong"),
                     tsc(u"Seetebosigo"), tsc(u"Phukwi"), tsc(u"Phatwe"), tsc(u"Lwetse"), tsc(u"Diphalane"),
                     tsc(u"Ngwanatsele"), tsc(u"Sedimonthole")},
             ...
             .am_pm = {tsc(u""), tsc(u"")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc(u"^[+1yYeE]"), .noexpr = tsc(u"^[-0nN]")},
    .paper = {.width = 210, .height = 297},
