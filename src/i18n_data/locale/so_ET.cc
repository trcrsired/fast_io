...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("so_ET"),
         ...
         .title = tsc("Somali language locale for Ethiopia"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"so_ET"),
         ...
         .title = tsc(L"Somali language locale for Ethiopia"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"so_ET"),
         ...
         .title = tsc(u8"Somali language locale for Ethiopia"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"so_ET"),
         ...
         .title = tsc(u"Somali language locale for Ethiopia"),
