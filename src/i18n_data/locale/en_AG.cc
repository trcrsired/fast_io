...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("en_AG"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("English language locale for Antigua and Barbuda"),
                       ...
                       .territory = tsc("Antigua & Barbuda"),
                       .revision = tsc("1.0"),
                       .date = tsc("2008-09-16")},
    .monetary = {.int_curr_symbol = tsc("XCD "),
                 .currency_symbol = tsc("$"),
    ...
    .address = {.postal_fmt = tsc("%f%N%a%N%d%N%b%N%s %h %e %r%N%%z %T%N%c%N"),
                .country_name = tsc("Antigua & Barbuda"),
                .country_ab2 = tsc("AG"),
                .country_ab3 = tsc("ATG"),
                .country_num = 28,
                .country_car = tsc("AG"),
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"en_AG"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"English language locale for Antigua and Barbuda"),
                       ...
                       .territory = tsc(L"Antigua & Barbuda"),
                       .revision = tsc(L"1.0"),
                       .date = tsc(L"2008-09-16")},
    .monetary = {.int_curr_symbol = tsc(L"XCD "),
    ...
    .address = {.postal_fmt = tsc(L"%f%N%a%N%d%N%b%N%s %h %e %r%N%%z %T%N%c%N"),
                .country_name = tsc(L"Antigua & Barbuda"),
                .country_ab2 = tsc(L"AG"),
                .country_ab3 = tsc(L"ATG"),
                .country_num = 28,
                .country_car = tsc(L"AG"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"en_AG"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"English language locale for Antigua and Barbuda"),
                       ...
                       .territory = tsc(u8"Antigua & Barbuda"),
                       .revision = tsc(u8"1.0"),
                       .date = tsc(u8"2008-09-16")},
    .monetary = {.int_curr_symbol = tsc(u8"XCD "),
    ...
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%%z %T%N%c%N"),
                .country_name = tsc(u8"Antigua & Barbuda"),
                .country_ab2 = tsc(u8"AG"),
                .country_ab3 = tsc(u8"ATG"),
                .country_num = 28,
                .country_car = tsc(u8"AG"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"en_AG"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"English language locale for Antigua and Barbuda"),
                       ...
                       .territory = tsc(u"Antigua & Barbuda"),
                       .revision = tsc(u"1.0"),
                       .date = tsc(u"2008-09-16")},
    .monetary = {.int_curr_symbol = tsc(u"XCD "),
    ...
    .address = {.postal_fmt = tsc(u"%f%N%a%N%d%N%b%N%s %h %e %r%N%%z %T%N%c%N"),
                .country_name = tsc(u"Antigua & Barbuda"),
                .country_ab2 = tsc(u"AG"),
                .country_ab3 = tsc(u"ATG"),
                .country_num = 28,
                .country_car = tsc(u"AG"),
