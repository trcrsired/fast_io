...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("ber_DZ"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("Berber language locale for Algeria (latin)"),
                       .source = tsc("fast_io"),
                       .address =
    ...
    .address = {.postal_fmt = tsc("%z%c%T%s%b%e%r"),
                ...
                .country_num = 12,
                .country_car = tsc("DZ"),
                .lang_name = tsc("Tamaziɣt"),
                .lang_term = tsc("ber"),
                .lang_lib = tsc("ber")},
    .measurement = {.measurement = 1}};

inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"ber_DZ"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"Berber language locale for Algeria (latin)"),
    ...
    .address = {.postal_fmt = tsc(L"%z%c%T%s%b%e%r"),
                ...
                .lang_name = tsc(L"Tamaziɣt"),
                .lang_term = tsc(L"ber"),
                .lang_lib = tsc(L"ber")},
    .measurement = {.measurement = 1}};

inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"ber_DZ"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"Berber language locale for Algeria (latin)"),
    ...
    .address = {.postal_fmt = tsc(u8"%z%c%T%s%b%e%r"),
                ...
                .lang_name = tsc(u8"Tamaziɣt"),
                .lang_term = tsc(u8"ber"),
                .lang_lib = tsc(u8"ber")},
    .measurement = {.measurement = 1}};

inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"ber_DZ"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"Berber language locale for Algeria (latin)"),
