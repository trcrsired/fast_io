...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("li_BE"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("Limburgish Language Locale for Belgium"),
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"li_BE"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"Limburgish Language Locale for Belgium"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"li_BE"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"Limburgish Language Locale for Belgium"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"li_BE"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"Limburgish Language Locale for Belgium"),
