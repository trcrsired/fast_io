...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("gez_ER@abegede"),
         .encoding = tsc(FAST_IO_LOCALE_ENCODING),
         .title = tsc("Ge'ez language locale for Eritrea With Abegede Collation."),
    ...
    .time = {.abday = {tsc("እኁድ"), tsc("ሰኑይ"), tsc("ሠሉስ"), tsc("ራብዕ"), tsc("ሐሙስ"), tsc("ዓርበ"), tsc("ቀዳሚ")},
             ...
             .abmon = {tsc("ጠሐረ"), tsc("ከተተ"), tsc("መገበ"), tsc("አኀዘ"), tsc("ግንባ"), tsc("ሠንየ"), tsc("ሐመለ"), tsc("ነሐሰ"),
                       tsc("ከረመ"), tsc("ጠቀመ"), tsc("ኀደረ"), tsc("ኀሠሠ")},
             .mon = {tsc("ጠሐረ"), tsc("ከተተ"), tsc("መገበ"), tsc("አኀዘ"), tsc("ግንባት"), tsc("ሠንየ"), tsc("ሐመለ"), tsc("ነሐሰ"),
                     tsc("ከረመ"), tsc("ጠቀመ"), tsc("ኀደረ"), tsc("ኀሠሠ")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"gez_ER@abegede"),
         .encoding = tsc(FAST_IO_LOCALE_LENCODING),
         .title = tsc(L"Ge'ez language locale for Eritrea With Abegede Collation."),
    ...
    .time = {.abday = {tsc(L"እኁድ"), tsc(L"ሰኑይ"), tsc(L"ሠሉስ"), tsc(L"ራብዕ"), tsc(L"ሐሙስ"), tsc(L"ዓርበ"), tsc(L"ቀዳሚ")},
             ...
             .abmon = {tsc(L"ጠሐረ"), tsc(L"ከተተ"), tsc(L"መገበ"), tsc(L"አኀዘ"), tsc(L"ግንባ"), tsc(L"ሠንየ"), tsc(L"ሐመለ"),
                       tsc(L"ነሐሰ"), tsc(L"ከረመ"), tsc(L"ጠቀመ"), tsc(L"ኀደረ"), tsc(L"ኀሠሠ")},
             .mon = {tsc(L"ጠሐረ"), tsc(L"ከተተ"), tsc(L"መገበ"), tsc(L"አኀዘ"), tsc(L"ግንባት"), tsc(L"ሠንየ"), tsc(L"ሐመለ"),
                     tsc(L"ነሐሰ"), tsc(L"ከረመ"), tsc(L"ጠቀመ"), tsc(L"ኀደረ"), tsc(L"ኀሠሠ")},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"gez_ER@abegede"),
         .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
         .title = tsc(u8"Ge'ez language locale for Eritrea With Abegede Collation."),
    ...
    .time = {.abday = {tsc(u8"እኁድ"), tsc(u8"ሰኑይ"), tsc(u8"ሠሉስ"), tsc(u8"ራብዕ"), tsc(u8"ሐሙስ"), tsc(u8"ዓርበ"),
             ...
             .abmon = {tsc(u8"ጠሐረ"), tsc(u8"ከተተ"), tsc(u8"መገበ"), tsc(u8"አኀዘ"), tsc(u8"ግንባ"), tsc(u8"ሠንየ"), tsc(u8"ሐመለ"),
                       tsc(u8"ነሐሰ"), tsc(u8"ከረመ"), tsc(u8"ጠቀመ"), tsc(u8"ኀደረ"), tsc(u8"ኀሠሠ")},
             .mon = {tsc(u8"ጠሐረ"), tsc(u8"ከተተ"), tsc(u8"መገበ"), tsc(u8"አኀዘ"), tsc(u8"ግንባት"), tsc(u8"ሠንየ"), tsc(u8"ሐመለ"),
                     tsc(u8"ነሐሰ"), tsc(u8"ከረመ"), tsc(u8"ጠቀመ"), tsc(u8"ኀደረ"), tsc(u8"ኀሠሠ")},
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"gez_ER@abegede"),
         .encoding = tsc(FAST_IO_LOCALE_uENCODING),
         .title = tsc(u"Ge'ez language locale for Eritrea With Abegede Collation."),
    ...
    .time = {.abday = {tsc(u"እኁድ"), tsc(u"ሰኑይ"), tsc(u"ሠሉስ"), tsc(u"ራብዕ"), tsc(u"ሐሙስ"), tsc(u"ዓርበ"), tsc(u"ቀዳሚ")},
             ...
             .abmon = {tsc(u"ጠሐረ"), tsc(u"ከተተ"), tsc(u"መገበ"), tsc(u"አኀዘ"), tsc(u"ግንባ"), tsc(u"ሠንየ"), tsc(u"ሐመለ"),
                       tsc(u"ነሐሰ"), tsc(u"ከረመ"), tsc(u"ጠቀመ"), tsc(u"ኀደረ"), tsc(u"ኀሠሠ")},
             .mon = {tsc(u"ጠሐረ"), tsc(u"ከተተ"), tsc(u"መገበ"), tsc(u"አኀዘ"), tsc(u"ግንባት"), tsc(u"ሠንየ"), tsc(u"ሐመለ"),
                     tsc(u"ነሐሰ"), tsc(u"ከረመ"), tsc(u"ጠቀመ"), tsc(u"ኀደረ"), tsc(u"ኀሠሠ")},
