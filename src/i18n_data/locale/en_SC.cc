...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("en_SC"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("English locale for the Seychelles"),
                       ...
                       .territory = tsc("Seychelles"),
                       .revision = tsc("1.0"),
                       .date = tsc("2017-07-24")},
    .monetary = {.int_curr_symbol = tsc("SCR "),
                 .currency_symbol = tsc("SR"),
    ...
    .telephone = {.int_select = tsc("00"), .int_prefix = tsc("248")},
    ...
    .address = {.postal_fmt = tsc("%f%N%h%s%N%T"),
                .country_name = tsc("Seychelles"),
                .country_ab2 = tsc("SC"),
                .country_ab3 = tsc("SYC"),
                .country_num = 690,
                .country_car = tsc("SY"),
                .country_isbn = tsc("978-99931"),
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"en_SC"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"English locale for the Seychelles"),
                       ...
                       .territory = tsc(L"Seychelles"),
                       .revision = tsc(L"1.0"),
                       .date = tsc(L"2017-07-24")},
    .monetary = {.int_curr_symbol = tsc(L"SCR "),
                 .currency_symbol = tsc(L"SR"),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.int_select = tsc(L"00"), .int_prefix = tsc(L"248")},
    ...
    .address = {.postal_fmt = tsc(L"%f%N%h%s%N%T"),
                .country_name = tsc(L"Seychelles"),
                .country_ab2 = tsc(L"SC"),
                .country_ab3 = tsc(L"SYC"),
                .country_num = 690,
                .country_car = tsc(L"SY"),
                .country_isbn = tsc(L"978-99931"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"en_SC"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"English locale for the Seychelles"),
                       ...
                       .territory = tsc(u8"Seychelles"),
                       .revision = tsc(u8"1.0"),
                       .date = tsc(u8"2017-07-24")},
    .monetary = {.int_curr_symbol = tsc(u8"SCR "),
                 .currency_symbol = tsc(u8"SR"),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.int_select = tsc(u8"00"), .int_prefix = tsc(u8"248")},
    ...
    .address = {.postal_fmt = tsc(u8"%f%N%h%s%N%T"),
                .country_name = tsc(u8"Seychelles"),
                .country_ab2 = tsc(u8"SC"),
                .country_ab3 = tsc(u8"SYC"),
                .country_num = 690,
                .country_car = tsc(u8"SY"),
                .country_isbn = tsc(u8"978-99931"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"en_SC"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"English locale for the Seychelles"),
                       ...
                       .territory = tsc(u"Seychelles"),
                       .revision = tsc(u"1.0"),
                       .date = tsc(u"2017-07-24")},
    .monetary = {.int_curr_symbol = tsc(u"SCR "),
                 .currency_symbol = tsc(u"SR"),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.int_select = tsc(u"00"), .int_prefix = tsc(u"248")},
    ...
    .address = {.postal_fmt = tsc(u"%f%N%h%s%N%T"),
                .country_name = tsc(u"Seychelles"),
                .country_ab2 = tsc(u"SC"),
                .country_ab3 = tsc(u"SYC"),
                .country_num = 690,
                .country_car = tsc(u"SY"),
                .country_isbn = tsc(u"978-99931"),
