...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("en_AU"),
         ...
         .title = tsc("English locale for Australia"),
         ...
         .tel = tsc(""),
         .fax = tsc(""),
         .language = tsc("Australian English"),
         .territory = tsc("Australia"),
         .revision = tsc("1.0"),
         .date = tsc("2000-06-29")},
    .monetary = {.int_curr_symbol = tsc("AUD "),
                 .currency_symbol = tsc("$"),
    ...
    .telephone = {.tel_int_fmt = tsc("+%c %a %l"), .int_select = tsc("0011"), .int_prefix = tsc("61")},
    .name = {.name_fmt = tsc("%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc("%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc("Australia"),
                .country_ab2 = tsc("AU"),
                .country_ab3 = tsc("AUS"),
                .country_num = 36,
                .country_car = tsc("AUS"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"en_AU"),
         ...
         .title = tsc(L"English locale for Australia"),
         ...
         .tel = tsc(L""),
         .fax = tsc(L""),
         .language = tsc(L"Australian English"),
         .territory = tsc(L"Australia"),
         .revision = tsc(L"1.0"),
         .date = tsc(L"2000-06-29")},
    .monetary = {.int_curr_symbol = tsc(L"AUD "),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(L"+%c %a %l"), .int_select = tsc(L"0011"), .int_prefix = tsc(L"61")},
    .name = {.name_fmt = tsc(L"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(L"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(L"Australia"),
                .country_ab2 = tsc(L"AU"),
                .country_ab3 = tsc(L"AUS"),
                .country_num = 36,
                .country_car = tsc(L"AUS"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"en_AU"),
         ...
         .title = tsc(u8"English locale for Australia"),
         ...
         .tel = tsc(u8""),
         .fax = tsc(u8""),
         .language = tsc(u8"Australian English"),
         .territory = tsc(u8"Australia"),
         .revision = tsc(u8"1.0"),
         .date = tsc(u8"2000-06-29")},
    .monetary = {.int_curr_symbol = tsc(u8"AUD "),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(u8"+%c %a %l"), .int_select = tsc(u8"0011"), .int_prefix = tsc(u8"61")},
    .name = {.name_fmt = tsc(u8"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u8"Australia"),
                .country_ab2 = tsc(u8"AU"),
                .country_ab3 = tsc(u8"AUS"),
                .country_num = 36,
                .country_car = tsc(u8"AUS"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"en_AU"),
         ...
         .title = tsc(u"English locale for Australia"),
         ...
         .tel = tsc(u""),
         .fax = tsc(u""),
         .language = tsc(u"Australian English"),
         .territory = tsc(u"Australia"),
         .revision = tsc(u"1.0"),
         .date = tsc(u"2000-06-29")},
    .monetary = {.int_curr_symbol = tsc(u"AUD "),
    ...
    .paper = {.width = 210, .height = 297},
    .telephone = {.tel_int_fmt = tsc(u"+%c %a %l"), .int_select = tsc(u"0011"), .int_prefix = tsc(u"61")},
    .name = {.name_fmt = tsc(u"%d%t%g%t%m%t%f")},
    .address = {.postal_fmt = tsc(u"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u"Australia"),
                .country_ab2 = tsc(u"AU"),
                .country_ab3 = tsc(u"AUS"),
                .country_num = 36,
                .country_car = tsc(u"AUS"),
