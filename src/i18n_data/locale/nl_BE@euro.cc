...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("nl_BE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("Dutch locale for Belgium with Euro"),
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"nl_BE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"Dutch locale for Belgium with Euro"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"nl_BE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"Dutch locale for Belgium with Euro"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"nl_BE@euro"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"Dutch locale for Belgium with Euro"),
