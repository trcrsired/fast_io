...
inline constexpr lc_all lc_all_global{
    .identification = {.name = tsc("wa_BE"),
                       .encoding = tsc(FAST_IO_LOCALE_ENCODING),
                       .title = tsc("Walloon Language Locale for Belgium"),
                       .source = tsc("Djan SACRE\t\t;\t\tfast_io"),
                       .address =
...
inline constexpr wlc_all wlc_all_global{
    .identification = {.name = tsc(L"wa_BE"),
                       .encoding = tsc(FAST_IO_LOCALE_LENCODING),
                       .title = tsc(L"Walloon Language Locale for Belgium"),
                       .source = tsc(L"Djan SACRE\t\t;\t\tfast_io"),
                       .address =
...
inline constexpr u8lc_all u8lc_all_global{
    .identification = {.name = tsc(u8"wa_BE"),
                       .encoding = tsc(FAST_IO_LOCALE_u8ENCODING),
                       .title = tsc(u8"Walloon Language Locale for Belgium"),
                       .source = tsc(u8"Djan SACRE\t\t;\t\tfast_io"),
                       .address =
...
inline constexpr u16lc_all u16lc_all_global{
    .identification = {.name = tsc(u"wa_BE"),
                       .encoding = tsc(FAST_IO_LOCALE_uENCODING),
                       .title = tsc(u"Walloon Language Locale for Belgium"),
                       .source = tsc(u"Djan SACRE\t\t;\t\tfast_io"),
                       .address =
