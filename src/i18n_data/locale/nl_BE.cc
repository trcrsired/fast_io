...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("nl_BE"),
         ...
         .title = tsc("Dutch locale for Belgium"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"nl_BE"),
         ...
         .title = tsc(L"Dutch locale for Belgium"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"nl_BE"),
         ...
         .title = tsc(u8"Dutch locale for Belgium"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"nl_BE"),
         ...
         .title = tsc(u"Dutch locale for Belgium"),
