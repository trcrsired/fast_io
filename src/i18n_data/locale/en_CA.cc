...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("en_CA"),
         ...
         .title = tsc("English locale for Canada"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"en_CA"),
         ...
         .title = tsc(L"English locale for Canada"),
         ...
         .tel = tsc(L""),
         .fax = tsc(L""),
         .language = tsc(L"Canadian English"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"en_CA"),
         ...
         .title = tsc(u8"English locale for Canada"),
         ...
         .tel = tsc(u8""),
         .fax = tsc(u8""),
         .language = tsc(u8"Canadian English"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"en_CA"),
         ...
         .title = tsc(u"English locale for Canada"),
         ...
         .tel = tsc(u""),
         .fax = tsc(u""),
         .language = tsc(u"Canadian English"),
