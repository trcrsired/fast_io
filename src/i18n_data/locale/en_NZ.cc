...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("en_NZ"),
         ...
         .title = tsc("English locale for New Zealand"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"en_NZ"),
         ...
         .title = tsc(L"English locale for New Zealand"),
    ...
    .address = {.postal_fmt = tsc(L"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(L"New Zealand"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"en_NZ"),
         ...
         .title = tsc(u8"English locale for New Zealand"),
    ...
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u8"New Zealand"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"en_NZ"),
         ...
         .title = tsc(u"English locale for New Zealand"),
    ...
    .address = {.postal_fmt = tsc(u"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc(u"New Zealand"),
