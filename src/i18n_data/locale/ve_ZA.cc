...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("ve_ZA"),
         ...
         .title = tsc("Venda locale for South Africa"),
    ...
    .time = {.abday = {tsc("Swo"), tsc("Mus"), tsc("Vhi"), tsc("Rar"), tsc("ṋa"), tsc("Ṱan"), tsc("Mug")},
             .day = {tsc("Swondaha"), tsc("Musumbuluwo"), tsc("Ḽavhuvhili"), tsc("Ḽavhuraru"), tsc("Ḽavhuṋa"),
                     tsc("Ḽavhuṱanu"), tsc("Mugivhela")},
             .abmon = {tsc("Pha"), tsc("Luh"), tsc("Fam"), tsc("Lam"), tsc("Shu"), tsc("Lwi"), tsc("Lwa"), tsc("Ngu"),
                       tsc("Khu"), tsc("Tsh"), tsc("Ḽar"), tsc("Nye")},
             .mon = {tsc("Phando"), tsc("Luhuhi"), tsc("Ṱhafamuhwe"), tsc("Lambamai"), tsc("Shundunthule"),
                     tsc("Fulwi"), tsc("Fulwana"), tsc("Ṱhangule"), tsc("Khubvumedzi"), tsc("Tshimedzi"), tsc("Ḽara"),
                     tsc("Nyendavhusiku")},
             ...
             .am_pm = {tsc(""), tsc("")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc("^[+1yYeE]"), .noexpr = tsc("^[-0nNhH]")},
    ...
    .address = {.postal_fmt = tsc("%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                .country_name = tsc("Afurika Tshipembe"),
                .country_post = tsc("ZA"),
                .country_ab2 = tsc("ZA"),
                .country_ab3 = tsc("ZAF"),
                .country_num = 710,
                .country_car = tsc("ZA"),
                .lang_name = tsc("Tshivenḓa"),
                .lang_ab = tsc("ve"),
                .lang_term = tsc("ven"),
                .lang_lib = tsc("ven")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"ve_ZA"),
         ...
         .title = tsc(L"Venda locale for South Africa"),
    ...
    .time = {.abday = {tsc(L"Swo"), tsc(L"Mus"), tsc(L"Vhi"), tsc(L"Rar"), tsc(L"ṋa"), tsc(L"Ṱan"), tsc(L"Mug")},
             .day = {tsc(L"Swondaha"), tsc(L"Musumbuluwo"), tsc(L"Ḽavhuvhili"), tsc(L"Ḽavhuraru"), tsc(L"Ḽavhuṋa"),
                     tsc(L"Ḽavhuṱanu"), tsc(L"Mugivhela")},
             .abmon = {tsc(L"Pha"), tsc(L"Luh"), tsc(L"Fam"), tsc(L"Lam"), tsc(L"Shu"), tsc(L"Lwi"), tsc(L"Lwa"),
                       tsc(L"Ngu"), tsc(L"Khu"), tsc(L"Tsh"), tsc(L"Ḽar"), tsc(L"Nye")},
             .mon = {tsc(L"Phando"), tsc(L"Luhuhi"), tsc(L"Ṱhafamuhwe"), tsc(L"Lambamai"), tsc(L"Shundunthule"),
                     tsc(L"Fulwi"), tsc(L"Fulwana"), tsc(L"Ṱhangule"), tsc(L"Khubvumedzi"), tsc(L"Tshimedzi"),
                     tsc(L"Ḽara"), tsc(L"Nyendavhusiku")},
             ...
             .am_pm = {tsc(L""), tsc(L"")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc(L"^[+1yYeE]"), .noexpr = tsc(L"^[-0nNhH]")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"ve_ZA"),
         ...
         .title = tsc(u8"Venda locale for South Africa"),
    ...
    .time = {.abday = {tsc(u8"Swo"), tsc(u8"Mus"), tsc(u8"Vhi"), tsc(u8"Rar"), tsc(u8"ṋa"), tsc(u8"Ṱan"), tsc(u8"Mug")},
             .day = {tsc(u8"Swondaha"), tsc(u8"Musumbuluwo"), tsc(u8"Ḽavhuvhili"), tsc(u8"Ḽavhuraru"), tsc(u8"Ḽavhuṋa"),
                     tsc(u8"Ḽavhuṱanu"), tsc(u8"Mugivhela")},
             .abmon = {tsc(u8"Pha"), tsc(u8"Luh"), tsc(u8"Fam"), tsc(u8"Lam"), tsc(u8"Shu"), tsc(u8"Lwi"), tsc(u8"Lwa"),
                       tsc(u8"Ngu"), tsc(u8"Khu"), tsc(u8"Tsh"), tsc(u8"Ḽar"), tsc(u8"Nye")},
             .mon = {tsc(u8"Phando"), tsc(u8"Luhuhi"), tsc(u8"Ṱhafamuhwe"), tsc(u8"Lambamai"), tsc(u8"Shundunthule"),
                     tsc(u8"Fulwi"), tsc(u8"Fulwana"), tsc(u8"Ṱhangule"), tsc(u8"Khubvumedzi"), tsc(u8"Tshimedzi"),
                     tsc(u8"Ḽara"), tsc(u8"Nyendavhusiku")},
             ...
             .am_pm = {tsc(u8""), tsc(u8"")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc(u8"^[+1yYeE]"), .noexpr = tsc(u8"^[-0nNhH]")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"ve_ZA"),
         ...
         .title = tsc(u"Venda locale for South Africa"),
    ...
    .time = {.abday = {tsc(u"Swo"), tsc(u"Mus"), tsc(u"Vhi"), tsc(u"Rar"), tsc(u"ṋa"), tsc(u"Ṱan"), tsc(u"Mug")},
             .day = {tsc(u"Swondaha"), tsc(u"Musumbuluwo"), tsc(u"Ḽavhuvhili"), tsc(u"Ḽavhuraru"), tsc(u"Ḽavhuṋa"),
                     tsc(u"Ḽavhuṱanu"), tsc(u"Mugivhela")},
             .abmon = {tsc(u"Pha"), tsc(u"Luh"), tsc(u"Fam"), tsc(u"Lam"), tsc(u"Shu"), tsc(u"Lwi"), tsc(u"Lwa"),
                       tsc(u"Ngu"), tsc(u"Khu"), tsc(u"Tsh"), tsc(u"Ḽar"), tsc(u"Nye")},
             .mon = {tsc(u"Phando"), tsc(u"Luhuhi"), tsc(u"Ṱhafamuhwe"), tsc(u"Lambamai"), tsc(u"Shundunthule"),
                     tsc(u"Fulwi"), tsc(u"Fulwana"), tsc(u"Ṱhangule"), tsc(u"Khubvumedzi"), tsc(u"Tshimedzi"),
                     tsc(u"Ḽara"), tsc(u"Nyendavhusiku")},
             ...
             .am_pm = {tsc(u""), tsc(u"")},
             .week = {7, 19971130, 1}},
    .messages = {.yesexpr = tsc(u"^[+1yYeE]"), .noexpr = tsc(u"^[-0nNhH]")},
    .paper = {.width = 210, .height = 297},
