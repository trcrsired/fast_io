...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("fa_IR"),
         ...
         .title = tsc("Persian locale for Iran"),
         .source = tsc("Sharif FarsiWeb, Inc.\t\t;\t\tfast_io"),
         .address =
             tsc("5, Shahid Ghasemi Habibollah, Azadi Ave, Tehran, "
                 "Iran\t\t;\t\thttps://gitee.com/qabeowjbtkwb/fast_io\t\t;\t\thttps://github.com/cppfastio/fast_io"),
         .contact = tsc("Roozbeh Pournader\t\t;\t\tfast_io"),
         .email = tsc("roozbeh@farsiweb.info;euloanty@live.com"),
         .tel = tsc(""),
         .fax = tsc(""),
         .language = tsc("Persian"),
         .territory = tsc("Iran"),
         .revision = tsc("3.0"),
         .date = tsc("2005-04-06")},
    ...
    .time = {.abday = {tsc("یکشنبه"), tsc("دوشنبه"), tsc("سه‌شنبه"), tsc("چهارشنبه"), tsc("پنجشنبه"),
                       tsc("جمعه"), tsc("شنبه")},
             .day = {tsc("یکشنبه"), tsc("دوشنبه"), tsc("سه‌شنبه"), tsc("چهارشنبه"), tsc("پنجشنبه"), tsc("جمعه"),
                     tsc("شنبه")},
             .abmon = {tsc("ژانویه"), tsc("فوریه"), tsc("مارس"), tsc("آوریل"), tsc("مه"), tsc("ژوئن"), tsc("ژوئیه"),
                       tsc("اوت"), tsc("سپتامبر"), tsc("اكتبر"), tsc("نوامبر"), tsc("دسامبر")},
             .mon = {tsc("ژانویه"), tsc("فوریه"), tsc("مارس"), tsc("آوریل"), tsc("مه"), tsc("ژوئن"), tsc("ژوئیه"),
                     tsc("اوت"), tsc("سپتامبر"), tsc("اكتبر"), tsc("نوامبر"), tsc("دسامبر")},
             .d_t_fmt = tsc("‫%A %Oe %B %Oy، %OH:%OM:%OS‬"),
             .d_fmt = tsc("%Oy//%Om//%Od"),
             .t_fmt = tsc("%OH:%OM:%OS"),
             .t_fmt_ampm = tsc(""),
             .date_fmt = tsc("‫%A %Oe %B %Oy، ساعت %OH:%OM:%OS (%Z)‬"),
             .am_pm = {tsc(""), tsc("")},
             ...
             .first_workday = 7,
             .cal_direction = 3},
    .messages = {.yesexpr = tsc("^[+1yYآبHf]"), .noexpr = tsc("^[-0nNخنok]"), .yesstr = tsc("بله"), .nostr = tsc("نه")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"fa_IR"),
         ...
         .title = tsc(L"Persian locale for Iran"),
         .source = tsc(L"Sharif FarsiWeb, Inc.\t\t;\t\tfast_io"),
         .address =
             tsc(L"5, Shahid Ghasemi Habibollah, Azadi Ave, Tehran, "
                 L"Iran\t\t;\t\thttps://gitee.com/qabeowjbtkwb/fast_io\t\t;\t\thttps://github.com/cppfastio/fast_io"),
         .contact = tsc(L"Roozbeh Pournader\t\t;\t\tfast_io"),
         .email = tsc(L"roozbeh@farsiweb.info;euloanty@live.com"),
         .tel = tsc(L""),
         .fax = tsc(L""),
         .language = tsc(L"Persian"),
         .territory = tsc(L"Iran"),
         .revision = tsc(L"3.0"),
         .date = tsc(L"2005-04-06")},
    ...
    .time = {.abday = {tsc(L"یکشنبه"), tsc(L"دوشنبه"), tsc(L"سه‌شنبه"), tsc(L"چهارشنبه"), tsc(L"پنجشنبه"),
                       tsc(L"جمعه"), tsc(L"شنبه")},
             .day = {tsc(L"یکشنبه"), tsc(L"دوشنبه"), tsc(L"سه‌شنبه"), tsc(L"چهارشنبه"), tsc(L"پنجشنبه"),
                     tsc(L"جمعه"), tsc(L"شنبه")},
             .abmon = {tsc(L"ژانویه"), tsc(L"فوریه"), tsc(L"مارس"), tsc(L"آوریل"), tsc(L"مه"), tsc(L"ژوئن"),
                       tsc(L"ژوئیه"), tsc(L"اوت"), tsc(L"سپتامبر"), tsc(L"اكتبر"), tsc(L"نوامبر"), tsc(L"دسامبر")},
             .mon = {tsc(L"ژانویه"), tsc(L"فوریه"), tsc(L"مارس"), tsc(L"آوریل"), tsc(L"مه"), tsc(L"ژوئن"),
                     tsc(L"ژوئیه"), tsc(L"اوت"), tsc(L"سپتامبر"), tsc(L"اكتبر"), tsc(L"نوامبر"), tsc(L"دسامبر")},
             .d_t_fmt = tsc(L"‫%A %Oe %B %Oy، %OH:%OM:%OS‬"),
             .d_fmt = tsc(L"%Oy//%Om//%Od"),
             .t_fmt = tsc(L"%OH:%OM:%OS"),
             .t_fmt_ampm = tsc(L""),
             .date_fmt = tsc(L"‫%A %Oe %B %Oy، ساعت %OH:%OM:%OS (%Z)‬"),
             .am_pm = {tsc(L""), tsc(L"")},
             ...
             .first_workday = 7,
             .cal_direction = 3},
    .messages = {.yesexpr = tsc(L"^[+1yYآبHf]"),
                 .noexpr = tsc(L"^[-0nNخنok]"),
                 .yesstr = tsc(L"بله"),
                 .nostr = tsc(L"نه")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"fa_IR"),
         ...
         .title = tsc(u8"Persian locale for Iran"),
         .source = tsc(u8"Sharif FarsiWeb, Inc.\t\t;\t\tfast_io"),
         .address =
             tsc(u8"5, Shahid Ghasemi Habibollah, Azadi Ave, Tehran, "
                 u8"Iran\t\t;\t\thttps://gitee.com/qabeowjbtkwb/fast_io\t\t;\t\thttps://github.com/cppfastio/fast_io"),
         .contact = tsc(u8"Roozbeh Pournader\t\t;\t\tfast_io"),
         .email = tsc(u8"roozbeh@farsiweb.info;euloanty@live.com"),
         .tel = tsc(u8""),
         .fax = tsc(u8""),
         .language = tsc(u8"Persian"),
         .territory = tsc(u8"Iran"),
         .revision = tsc(u8"3.0"),
         .date = tsc(u8"2005-04-06")},
    ...
    .time = {.abday = {tsc(u8"یکشنبه"), tsc(u8"دوشنبه"), tsc(u8"سه‌شنبه"), tsc(u8"چهارشنبه"), tsc(u8"پنجشنبه"),
                       tsc(u8"جمعه"), tsc(u8"شنبه")},
             .day = {tsc(u8"یکشنبه"), tsc(u8"دوشنبه"), tsc(u8"سه‌شنبه"), tsc(u8"چهارشنبه"), tsc(u8"پنجشنبه"),
                     tsc(u8"جمعه"), tsc(u8"شنبه")},
             .abmon = {tsc(u8"ژانویه"), tsc(u8"فوریه"), tsc(u8"مارس"), tsc(u8"آوریل"), tsc(u8"مه"), tsc(u8"ژوئن"),
                       tsc(u8"ژوئیه"), tsc(u8"اوت"), tsc(u8"سپتامبر"), tsc(u8"اكتبر"), tsc(u8"نوامبر"),
                       tsc(u8"دسامبر")},
             .mon = {tsc(u8"ژانویه"), tsc(u8"فوریه"), tsc(u8"مارس"), tsc(u8"آوریل"), tsc(u8"مه"), tsc(u8"ژوئن"),
                     tsc(u8"ژوئیه"), tsc(u8"اوت"), tsc(u8"سپتامبر"), tsc(u8"اكتبر"), tsc(u8"نوامبر"), tsc(u8"دسامبر")},
             .d_t_fmt = tsc(u8"‫%A %Oe %B %Oy، %OH:%OM:%OS‬"),
             .d_fmt = tsc(u8"%Oy//%Om//%Od"),
             .t_fmt = tsc(u8"%OH:%OM:%OS"),
             .t_fmt_ampm = tsc(u8""),
             .date_fmt = tsc(u8"‫%A %Oe %B %Oy، ساعت %OH:%OM:%OS (%Z)‬"),
             .am_pm = {tsc(u8""), tsc(u8"")},
             ...
             .first_workday = 7,
             .cal_direction = 3},
    .messages = {.yesexpr = tsc(u8"^[+1yYآبHf]"),
                 .noexpr = tsc(u8"^[-0nNخنok]"),
                 .yesstr = tsc(u8"بله"),
                 .nostr = tsc(u8"نه")},
    .paper = {.width = 210, .height = 297},
    ...
    .name = {.name_fmt = tsc(u8"%d%t%s%t%g%t%m%t%f"),
             .name_gen = tsc(u8""),
             .name_miss = tsc(u8"خانم"),
             .name_mr = tsc(u8"آقای"),
             .name_mrs = tsc(u8"خانم"),
             .name_ms = tsc(u8"خانم")},
    .address = {.postal_fmt = tsc(u8"%f%N%a%N%d%N%b%N%s %h %e %r%N%z %T%N%c%N"),
                ...
                .lang_name = tsc(u8"فارسی"),
                .lang_ab = tsc(u8"fa"),
                .lang_term = tsc(u8"fas"),
                .lang_lib = tsc(u8"per")},
    .measurement = {.measurement = 1}};
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"fa_IR"),
         ...
         .title = tsc(u"Persian locale for Iran"),
         .source = tsc(u"Sharif FarsiWeb, Inc.\t\t;\t\tfast_io"),
         .address =
             tsc(u"5, Shahid Ghasemi Habibollah, Azadi Ave, Tehran, "
                 u"Iran\t\t;\t\thttps://gitee.com/qabeowjbtkwb/fast_io\t\t;\t\thttps://github.com/cppfastio/fast_io"),
         .contact = tsc(u"Roozbeh Pournader\t\t;\t\tfast_io"),
         .email = tsc(u"roozbeh@farsiweb.info;euloanty@live.com"),
         .tel = tsc(u""),
         .fax = tsc(u""),
         .language = tsc(u"Persian"),
         .territory = tsc(u"Iran"),
         .revision = tsc(u"3.0"),
         .date = tsc(u"2005-04-06")},
    ...
    .time = {.abday = {tsc(u"یکشنبه"), tsc(u"دوشنبه"), tsc(u"سه‌شنبه"), tsc(u"چهارشنبه"), tsc(u"پنجشنبه"),
                       tsc(u"جمعه"), tsc(u"شنبه")},
             .day = {tsc(u"یکشنبه"), tsc(u"دوشنبه"), tsc(u"سه‌شنبه"), tsc(u"چهارشنبه"), tsc(u"پنجشنبه"),
                     tsc(u"جمعه"), tsc(u"شنبه")},
             .abmon = {tsc(u"ژانویه"), tsc(u"فوریه"), tsc(u"مارس"), tsc(u"آوریل"), tsc(u"مه"), tsc(u"ژوئن"),
                       tsc(u"ژوئیه"), tsc(u"اوت"), tsc(u"سپتامبر"), tsc(u"اكتبر"), tsc(u"نوامبر"), tsc(u"دسامبر")},
             .mon = {tsc(u"ژانویه"), tsc(u"فوریه"), tsc(u"مارس"), tsc(u"آوریل"), tsc(u"مه"), tsc(u"ژوئن"),
                     tsc(u"ژوئیه"), tsc(u"اوت"), tsc(u"سپتامبر"), tsc(u"اكتبر"), tsc(u"نوامبر"), tsc(u"دسامبر")},
             .d_t_fmt = tsc(u"‫%A %Oe %B %Oy، %OH:%OM:%OS‬"),
             .d_fmt = tsc(u"%Oy//%Om//%Od"),
             .t_fmt = tsc(u"%OH:%OM:%OS"),
             .t_fmt_ampm = tsc(u""),
             .date_fmt = tsc(u"‫%A %Oe %B %Oy، ساعت %OH:%OM:%OS (%Z)‬"),
             .am_pm = {tsc(u""), tsc(u"")},
             ...
             .first_workday = 7,
             .cal_direction = 3},
    .messages = {.yesexpr = tsc(u"^[+1yYآبHf]"),
                 .noexpr = tsc(u"^[-0nNخنok]"),
                 .yesstr = tsc(u"بله"),
                 .nostr = tsc(u"نه")},
    .paper = {.width = 210, .height = 297},
