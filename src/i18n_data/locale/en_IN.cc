...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("en_IN"),
         ...
         .title = tsc("English language locale for India"),
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"en_IN"),
         ...
         .title = tsc(L"English language locale for India"),
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"en_IN"),
         ...
         .title = tsc(u8"English language locale for India"),
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"en_IN"),
         ...
         .title = tsc(u"English language locale for India"),
