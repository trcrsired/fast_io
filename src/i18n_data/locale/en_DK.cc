...
inline constexpr lc_all lc_all_global{
    .identification =
        {.name = tsc("en_DK"),
         ...
         .title = tsc("English locale for Denmark"),
    ...
    .time = {.abday = {tsc("Sun"), tsc("Mon"), tsc("Tue"), tsc("Wed"), tsc("Thu"), tsc("Fri"), tsc("Sat")},
             ...
             .d_t_fmt = tsc("%Y-%m-%dT%T %Z"),
             .d_fmt = tsc("%Y-%m-%d"),
             .t_fmt = tsc("%T"),
             .t_fmt_ampm = tsc(""),
             .date_fmt = tsc("%Y-%m-%dT%T %Z"),
             .am_pm = {tsc(""), tsc("")},
             .week = {7, 19971130, 4},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc("^[+1yYjJsSoO]"), .noexpr = tsc("^[-0nN]"), .yesstr = tsc("yes"), .nostr = tsc("no")},
...
inline constexpr wlc_all wlc_all_global{
    .identification =
        {.name = tsc(L"en_DK"),
         ...
         .title = tsc(L"English locale for Denmark"),
    ...
    .time = {.abday = {tsc(L"Sun"), tsc(L"Mon"), tsc(L"Tue"), tsc(L"Wed"), tsc(L"Thu"), tsc(L"Fri"), tsc(L"Sat")},
             ...
             .mon = {tsc(L"January"), tsc(L"February"), tsc(L"March"), tsc(L"April"), tsc(L"May"), tsc(L"June"),
                     ...
                     tsc(L"December")},
             .d_t_fmt = tsc(L"%Y-%m-%dT%T %Z"),
             .d_fmt = tsc(L"%Y-%m-%d"),
             .t_fmt = tsc(L"%T"),
             .t_fmt_ampm = tsc(L""),
             .date_fmt = tsc(L"%Y-%m-%dT%T %Z"),
             .am_pm = {tsc(L""), tsc(L"")},
             .week = {7, 19971130, 4},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc(L"^[+1yYjJsSoO]"),
                 .noexpr = tsc(L"^[-0nN]"),
                 .yesstr = tsc(L"yes"),
                 .nostr = tsc(L"no")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u8lc_all u8lc_all_global{
    .identification =
        {.name = tsc(u8"en_DK"),
         ...
         .title = tsc(u8"English locale for Denmark"),
    ...
    .time = {.abday = {tsc(u8"Sun"), tsc(u8"Mon"), tsc(u8"Tue"), tsc(u8"Wed"), tsc(u8"Thu"), tsc(u8"Fri"),
             ...
             .mon = {tsc(u8"January"), tsc(u8"February"), tsc(u8"March"), tsc(u8"April"), tsc(u8"May"), tsc(u8"June"),
                     ...
                     tsc(u8"December")},
             .d_t_fmt = tsc(u8"%Y-%m-%dT%T %Z"),
             .d_fmt = tsc(u8"%Y-%m-%d"),
             .t_fmt = tsc(u8"%T"),
             .t_fmt_ampm = tsc(u8""),
             .date_fmt = tsc(u8"%Y-%m-%dT%T %Z"),
             .am_pm = {tsc(u8""), tsc(u8"")},
             .week = {7, 19971130, 4},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc(u8"^[+1yYjJsSoO]"),
                 .noexpr = tsc(u8"^[-0nN]"),
                 .yesstr = tsc(u8"yes"),
                 .nostr = tsc(u8"no")},
    .paper = {.width = 210, .height = 297},
...
inline constexpr u16lc_all u16lc_all_global{
    .identification =
        {.name = tsc(u"en_DK"),
         ...
         .title = tsc(u"English locale for Denmark"),
    ...
    .time = {.abday = {tsc(u"Sun"), tsc(u"Mon"), tsc(u"Tue"), tsc(u"Wed"), tsc(u"Thu"), tsc(u"Fri"), tsc(u"Sat")},
             ...
             .mon = {tsc(u"January"), tsc(u"February"), tsc(u"March"), tsc(u"April"), tsc(u"May"), tsc(u"June"),
                     ...
                     tsc(u"December")},
             .d_t_fmt = tsc(u"%Y-%m-%dT%T %Z"),
             .d_fmt = tsc(u"%Y-%m-%d"),
             .t_fmt = tsc(u"%T"),
             .t_fmt_ampm = tsc(u""),
             .date_fmt = tsc(u"%Y-%m-%dT%T %Z"),
             .am_pm = {tsc(u""), tsc(u"")},
             .week = {7, 19971130, 4},
             .first_weekday = 2},
    .messages = {.yesexpr = tsc(u"^[+1yYjJsSoO]"),
                 .noexpr = tsc(u"^[-0nN]"),
                 .yesstr = tsc(u"yes"),
                 .nostr = tsc(u"no")},
    .paper = {.width = 210, .height = 297},
