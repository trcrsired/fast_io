...
struct decofiltest {
    ...
    static inline constexpr ::fast_io::deco_result<char, char> process_chars(input_char_type const *fromfirst,
                                                                             input_char_type const *fromlast,
                                                                             output_char_type *tofirst,
                                                                             output_char_type *tolast) noexcept {
...
int main() {
    ::fast_io::iobuf_io_file file(::fast_io::io_cookie_type<::fast_io::native_file>, u8"io_file_deco.txt",
