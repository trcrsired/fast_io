...
scatter_write_some_bytes_overflow_define(foo f, ::fast_io::io_scatter_t const *base, ::std::size_t len) {
...
inline ::fast_io::io_scatter_status_t
scatter_read_some_bytes_underflow_define(foo f, ::fast_io::io_scatter_t const *base, ::std::size_t len) {
