...
inline ::std::byte *read_some_bytes_define(::fast_io::posix_io_observer piob, ::std::byte *first, ::std::byte *last) {
    return read(piob, first, last);
}

inline ::std::byte const *write_some_bytes_define(::fast_io::posix_io_observer piob, ::std::byte const *first,
                                                  ::std::byte const *last) {
